...
class ModelBuilder:
    ...
    def soft_mesh_count(self):
        """
        The number of soft meshes (deformable bodies) in the model.
        """
    ...
    def add_soft_grid(
        ...
        self.soft_mesh_scale.append(1.0)  # soft_grid doesn't have scale parameter, default to 1.0
