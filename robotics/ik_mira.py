...
ASSETS_DIR = Path(__file__).resolve().parent.parent / "assets" / "Robots"
...
class Example:
    def __init__(self, viewer, args):
        ...
        # ------------------------------------------------------------------
        # Build MIRA bipolar (fixed base) + ground
        # ------------------------------------------------------------------
        builder = newton.ModelBuilder()

        builder.add_usd(
            str(ASSETS_DIR / "MIRA" / "mira-bipo-size-experiment-smoothing.usd"),
            floating=False,
        )
