...
from .warpsurgical_env_cfg import WarpsurgicalEnvCfg
...
class WarpsurgicalEnv(DirectRLEnv):
    cfg: WarpsurgicalEnvCfg

    def __init__(self, cfg: WarpsurgicalEnvCfg, render_mode: str | None = None, **kwargs):
