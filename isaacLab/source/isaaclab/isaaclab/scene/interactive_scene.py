...
from isaaclab.assets import Articulation, ArticulationCfg, AssetBaseCfg, DeformableObject, DeformableObjectCfg
...
class InteractiveScene:
    ...
    * For tasks that require having separate assets in the environments, ``replicate_physics`` would have to
    ...
    def reset(self, env_ids: Sequence[int] | None = None):
        ...
        for deformable_obj in self._deformable_objects.values():
    ...
    def write_data_to_sim(self):
        ...
        for deformable_obj in self._deformable_objects.values():
            deformable_obj.write_data_to_sim()
