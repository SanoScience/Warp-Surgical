...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/physics/collision.py:5
static wp::vec_t<3, wp::float32> double_sided_fallback_dir_0(
    ...
    wp::vec_t<3, wp::float32> var_reference_dir)
{
    ...
    //---------
    // forward
    // def double_sided_fallback_dir(                                                         <L 6>
    // if wp.length_sq(reference_dir) > 1.0e-12:                                              <L 13>
    var_0 = wp::length_sq(var_reference_dir);
    var_2 = (var_0 > var_1);
    if (var_2) {
        // return wp.normalize(reference_dir)                                                 <L 14>
        var_3 = wp::normalize(var_reference_dir);
        return var_3;
    }
    // centroid = (v0 + v1 + v2) / 3.0                                                        <L 16>
    var_4 = wp::add(var_v0, var_v1);
    var_5 = wp::add(var_4, var_v2);
    var_7 = wp::div(var_5, var_6);
    // centroid_dir = centroid - contact_point                                                <L 17>
    var_8 = wp::sub(var_7, var_contact_point);
    // if wp.length_sq(centroid_dir) > 1.0e-12:                                               <L 18>
    var_9 = wp::length_sq(var_8);
    var_11 = (var_9 > var_10);
    if (var_11) {
        // return wp.normalize(centroid_dir)                                                  <L 19>
        var_12 = wp::normalize(var_8);
        return var_12;
    }
    // d0 = v0 - contact_point                                                                <L 21>
    var_13 = wp::sub(var_v0, var_contact_point);
    // d1 = v1 - contact_point                                                                <L 22>
    var_14 = wp::sub(var_v1, var_contact_point);
    // d2 = v2 - contact_point                                                                <L 23>
    var_15 = wp::sub(var_v2, var_contact_point);
    // best = d0                                                                              <L 25>
    var_16 = wp::copy(var_13);
    // if wp.length_sq(d1) > wp.length_sq(best):                                              <L 26>
    ...
    // if wp.length_sq(d2) > wp.length_sq(best):                                              <L 28>
    ...
    // if wp.length_sq(best) > 1.0e-12:                                                       <L 31>
    var_27 = wp::length_sq(var_26);
    var_29 = (var_27 > var_28);
    if (var_29) {
        // return wp.normalize(best)                                                          <L 32>
        var_30 = wp::normalize(var_26);
        return var_30;
    }
    // return wp.vec3f(1.0, 0.0, 0.0)                                                         <L 34>
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/physics/collision.py:5
static void adj_double_sided_fallback_dir_0(
    wp::vec_t<3, wp::float32> var_v0,
    wp::vec_t<3, wp::float32> var_v1,
    wp::vec_t<3, wp::float32> var_v2,
    wp::vec_t<3, wp::float32> var_contact_point,
    ...
    wp::vec_t<3, wp::float32> & adj_ret)
{
    ...
    // adj: return wp.vec3f(1.0, 0.0, 0.0)                                                    <L 34>
    if (var_29) {
        label2:;
        adj_30 += adj_ret;
        wp::adj_normalize(var_26, var_30, adj_26, adj_30);
        // adj: return wp.normalize(best)                                                     <L 32>
    }
    wp::adj_length_sq(var_26, adj_26, adj_27);
    // adj: if wp.length_sq(best) > 1.0e-12:                                                  <L 31>
    ...
    // adj: if wp.length_sq(d2) > wp.length_sq(best):                                         <L 28>
    ...
    // adj: centroid = (v0 + v1 + v2) / 3.0                                                   <L 16>
    if (var_2) {
        label0:;
        adj_3 += adj_ret;
        wp::adj_normalize(var_reference_dir, var_3, adj_reference_dir, adj_3);
        // adj: return wp.normalize(reference_dir)                                            <L 14>
    }
    wp::adj_length_sq(var_reference_dir, adj_reference_dir, adj_0);
    // adj: if wp.length_sq(reference_dir) > 1.0e-12:                                         <L 13>
    // adj: def double_sided_fallback_dir(                                                    <L 6>
    return;
}

struct wp_args_collide_triangles_vs_sphere_b0ada449 {
...
void collide_triangles_vs_sphere_b0ada449_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_collide_triangles_vs_sphere_b0ada449 *_wp_args)
{
    //---------
    // argument vars
    ...
    //---------
    // forward
    // def collide_triangles_vs_sphere(                                                       <L 38>
    // tid = wp.tid()                                                                         <L 52>
    var_0 = builtin_tid1d();
    // if tid >= tri_indices.shape[0]:                                                        <L 53>
    ...
    // closest_p, bary, feature_type = triangle_closest_point(p1, p2, p3, sphere_pos)         <L 78>
    triangle_closest_point_0(var_19, var_22, var_25, var_29, var_53, var_54, var_55);
    // to_sphere = closest_p - sphere_pos                                                     <L 79>
    var_56 = wp::sub(var_53, var_29);
    // dist = wp.length(to_sphere)                                                            <L 80>
    var_57 = wp::length(var_56);
    // if dist >= sphere_radius:                                                              <L 81>
    var_58 = (var_57 >= var_sphere_radius);
    if (var_58) {
        // return                                                                             <L 82>
        return;
    }
    // penetration = sphere_radius - dist                                                     <L 84>
    var_59 = wp::sub(var_sphere_radius, var_57);
    // if dist > 1e-8:                                                                        <L 85>
    var_61 = (var_57 > var_60);
    if (var_61) {
        // correction_dir = to_sphere / dist                                                  <L 86>
        var_62 = wp::div(var_56, var_57);
    }
    if (!var_61) {
        // correction_dir = double_sided_fallback_dir(                                        <L 88>
        // p1,                                                                                <L 89>
        // p2,                                                                                <L 90>
        // p3,                                                                                <L 91>
        // sphere_pos,                                                                        <L 92>
        // -((velocities[t1] + velocities[t2] + velocities[t3]) / 3.0),                       <L 93>
        ...
        var_74 = double_sided_fallback_dir_0(var_19, var_22, var_25, var_29, var_73);
    }
    var_75 = wp::where(var_61, var_62, var_74);
    // total_correction = correction_dir * penetration                                        <L 96>
    var_76 = wp::mul(var_75, var_59);
    // d1 = total_correction * (w1 / weight)                                                  <L 97>
    var_77 = wp::div(var_41, var_50);
    var_78 = wp::mul(var_76, var_77);
    // d2 = total_correction * (w2 / weight)                                                  <L 98>
    var_79 = wp::div(var_44, var_50);
    var_80 = wp::mul(var_76, var_79);
    // d3 = total_correction * (w3 / weight)                                                  <L 99>
    var_81 = wp::div(var_47, var_50);
    var_82 = wp::mul(var_76, var_81);
    // wp.atomic_add(delta_accumulator, t1, d1)                                               <L 101>
    var_83 = wp::atomic_add(var_delta_accumulator, var_8, var_78);
    // wp.atomic_add(delta_accumulator, t2, d2)                                               <L 102>
    var_84 = wp::atomic_add(var_delta_accumulator, var_12, var_80);
    // wp.atomic_add(delta_accumulator, t3, d3)                                               <L 103>
    var_85 = wp::atomic_add(var_delta_accumulator, var_16, var_82);
    // wp.atomic_add(delta_counter, t1, 1)                                                    <L 104>
    var_87 = wp::atomic_add(var_delta_counter, var_8, var_86);
    // wp.atomic_add(delta_counter, t2, 1)                                                    <L 105>
    var_89 = wp::atomic_add(var_delta_counter, var_12, var_88);
    // wp.atomic_add(delta_counter, t3, 1)                                                    <L 106>
    var_91 = wp::atomic_add(var_delta_counter, var_16, var_90);
}



void collide_triangles_vs_sphere_b0ada449_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_collide_triangles_vs_sphere_b0ada449 *_wp_args,
    wp_args_collide_triangles_vs_sphere_b0ada449 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_positions = _wp_args->positions;
    ...
    if (!var_61) {
        ...
        // adj: -((velocities[t1] + velocities[t2] + velocities[t3]) / 3.0),                  <L 93>
        // adj: sphere_pos,                                                                   <L 92>
        // adj: p3,                                                                           <L 91>
        // adj: p2,                                                                           <L 90>
        // adj: p1,                                                                           <L 89>
        // adj: correction_dir = double_sided_fallback_dir(                                   <L 88>
    }
    if (var_61) {
        wp::adj_div(var_56, var_57, adj_56, adj_57, adj_62);
        // adj: correction_dir = to_sphere / dist                                             <L 86>
    }
    // adj: if dist > 1e-8:                                                                   <L 85>
    wp::adj_sub(var_sphere_radius, var_57, adj_sphere_radius, adj_57, adj_59);
    // adj: penetration = sphere_radius - dist                                                <L 84>
    if (var_58) {
        label3:;
        // adj: return                                                                        <L 82>
    }
    // adj: if dist >= sphere_radius:                                                         <L 81>
    wp::adj_length(var_56, var_57, adj_56, adj_57);
    // adj: dist = wp.length(to_sphere)                                                       <L 80>
    wp::adj_sub(var_53, var_29, adj_53, adj_29, adj_56);
    // adj: to_sphere = closest_p - sphere_pos                                                <L 79>
    ...
    if (var_32) {
        ...
        // adj: if wp.length(centroid - sphere_pos) > cull_radius:                            <L 68>
        ...
        // adj: centroid = (p1 + p2 + p3) / 3.0                                               <L 67>
    }
    // adj: if cull_radius > 0.0:                                                             <L 66>
    ...
    // adj: if tid >= tri_indices.shape[0]:                                                   <L 53>
    // adj: tid = wp.tid()                                                                    <L 52>
    // adj: def collide_triangles_vs_sphere(                                                  <L 38>
    return;
}
...
WP_API void collide_triangles_vs_sphere_b0ada449_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_collide_triangles_vs_sphere_b0ada449 *_wp_args)
{
    ...
    {
        collide_triangles_vs_sphere_b0ada449_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void collide_triangles_vs_sphere_b0ada449_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_collide_triangles_vs_sphere_b0ada449 *_wp_args,
    wp_args_collide_triangles_vs_sphere_b0ada449 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        collide_triangles_vs_sphere_b0ada449_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}
