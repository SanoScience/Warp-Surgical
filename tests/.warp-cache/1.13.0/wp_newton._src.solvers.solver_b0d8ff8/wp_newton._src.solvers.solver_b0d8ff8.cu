...
static CUDA_CALLABLE void integrate_rigid_body_0(
...
// /home/pkorzeniowsk/Projects/newton/newton-1.0/newton/_src/solvers/solver.py:51
static CUDA_CALLABLE void adj_integrate_rigid_body_0(
    wp::transform_t<wp::float32> var_q,
    wp::vec_t<6, wp::float32> var_qd,
    wp::vec_t<6, wp::float32> var_f,
    wp::vec_t<3, wp::float32> var_com,
...
extern "C" __global__ void integrate_bodies_6b670ad3_cuda_kernel_forward(
...
extern "C" __global__ void integrate_bodies_6b670ad3_cuda_kernel_backward(
    wp::launch_bounds_t dim,
    wp::array_t<wp::transform_t<wp::float32>> var_body_q,
    wp::array_t<wp::vec_t<6, wp::float32>> var_body_qd,
    wp::array_t<wp::vec_t<6, wp::float32>> var_body_f,
    ...
    wp::array_t<wp::int32> adj_body_world,
...
extern "C" __global__ void _update_effective_inv_mass_inertia_79ac0336_cuda_kernel_forward(
    wp::launch_bounds_t dim,
    wp::array_t<wp::int32> var_body_flags,
    wp::array_t<wp::float32> var_model_inv_mass,
    wp::array_t<wp::mat_t<3, 3, wp::float32>> var_model_inv_inertia,
    wp::array_t<wp::float32> var_eff_inv_mass,
    wp::array_t<wp::mat_t<3, 3, wp::float32>> var_eff_inv_inertia)
{
    wp::tile_shared_storage_t tile_mem;
...
extern "C" __global__ void _update_effective_inv_mass_inertia_79ac0336_cuda_kernel_backward(
    wp::launch_bounds_t dim,
    wp::array_t<wp::int32> var_body_flags,
    wp::array_t<wp::float32> var_model_inv_mass,
    wp::array_t<wp::mat_t<3, 3, wp::float32>> var_model_inv_inertia,
    ...
    wp::array_t<wp::mat_t<3, 3, wp::float32>> var_eff_inv_inertia,
    wp::array_t<wp::int32> adj_body_flags,
    wp::array_t<wp::float32> adj_model_inv_mass,
    wp::array_t<wp::mat_t<3, 3, wp::float32>> adj_model_inv_inertia,
    wp::array_t<wp::float32> adj_eff_inv_mass,
    wp::array_t<wp::mat_t<3, 3, wp::float32>> adj_eff_inv_inertia)
{
    wp::tile_shared_storage_t tile_mem;
...
extern "C" __global__ void integrate_particles_b575d3f3_cuda_kernel_forward(
    wp::launch_bounds_t dim,
    ...
    wp::array_t<wp::int32> var_particle_world,
    wp::array_t<wp::vec_t<3, wp::float32>> var_gravity,
    wp::float32 var_dt,
...
extern "C" __global__ void integrate_particles_b575d3f3_cuda_kernel_backward(
    wp::launch_bounds_t dim,
    wp::array_t<wp::vec_t<3, wp::float32>> var_x,
    wp::array_t<wp::vec_t<3, wp::float32>> var_v,
    wp::array_t<wp::vec_t<3, wp::float32>> var_f,
    ...
    wp::array_t<wp::int32> adj_particle_world,
    wp::array_t<wp::vec_t<3, wp::float32>> adj_gravity,
    wp::float32 adj_dt,
