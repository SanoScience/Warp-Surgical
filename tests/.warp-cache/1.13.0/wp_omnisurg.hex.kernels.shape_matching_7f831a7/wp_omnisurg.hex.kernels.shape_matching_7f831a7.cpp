...
static wp::quat_t<wp::float32> _extract_rotation_0(
...
static wp::float32 _support_scale_from_alpha_0(
...
static wp::float32 _uniform8_slot_sign_x_0(
    wp::int32 var_slot)
{
    //---------
    // primal vars
...
static wp::float32 _uniform8_slot_sign_y_0(
    wp::int32 var_slot)
{
    //---------
    // primal vars
...
static wp::float32 _uniform8_slot_sign_z_0(
    wp::int32 var_slot)
{
    //---------
    // primal vars
...
static wp::int32 _slot_uses_upper_x_0(
    wp::int32 var_slot)
{
    //---------
    // primal vars
...
static wp::int32 _slot_uses_upper_y_0(
    wp::int32 var_slot)
{
    //---------
    // primal vars
...
static wp::int32 _slot_uses_upper_z_0(
    wp::int32 var_slot)
{
    //---------
    // primal vars
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/shape_matching.py:20
static void adj__extract_rotation_0(
    wp::mat_t<3, 3, wp::float32> var_a,
    wp::quat_t<wp::float32> var_q_init,
    wp::int32 var_max_iters,
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/shape_matching.py:74
static void adj__support_scale_from_alpha_0(
    wp::float32 var_inv_weight,
    wp::float32 var_support_alpha,
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/shape_matching.py:87
static void adj__uniform8_slot_sign_x_0(
    wp::int32 var_slot,
    wp::int32 & adj_slot,
    wp::float32 & adj_ret)
{
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/shape_matching.py:94
static void adj__uniform8_slot_sign_y_0(
    wp::int32 var_slot,
    wp::int32 & adj_slot,
    wp::float32 & adj_ret)
{
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/shape_matching.py:101
static void adj__uniform8_slot_sign_z_0(
    wp::int32 var_slot,
    wp::int32 & adj_slot,
    wp::float32 & adj_ret)
{
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/shape_matching.py:994
static void adj__slot_uses_upper_x_0(
    wp::int32 var_slot,
    wp::int32 & adj_slot,
    wp::int32 & adj_ret)
{
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/shape_matching.py:1001
static void adj__slot_uses_upper_y_0(
    wp::int32 var_slot,
    wp::int32 & adj_slot,
    wp::int32 & adj_ret)
{
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/shape_matching.py:1008
static void adj__slot_uses_upper_z_0(
    wp::int32 var_slot,
    wp::int32 & adj_slot,
    wp::int32 & adj_ret)
{
...
struct wp_args_apply_shape_matching_particle_gather_uniform8_a9a23521 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q_init;
    ...
    wp::array_t<wp::int32> particle_cluster_offsets;
    wp::array_t<wp::int32> particle_cluster_indices;
    wp::array_t<wp::int32> particle_cluster_member_offsets;
    wp::array_t<wp::vec_t<3, wp::float32>> rest_local_positions_by_slot;
    wp::array_t<wp::vec_t<3, wp::float32>> rest_local_template;
    wp::array_t<wp::float32> coefficients;
    wp::array_t<wp::int32> cluster_active;
    wp::array_t<wp::float32> particle_cluster_inv_weights;
    wp::int32 cluster_count;
    wp::int32 use_rest_local_template;
    wp::float32 stiffness;
    wp::array_t<wp::quat_t<wp::float32>> cluster_rotations;
    wp::array_t<wp::vec_t<3, wp::float32>> cluster_translations;
    wp::int32 include_base_delta;
    wp::float32 dt;
    wp::float32 v_max;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q_out;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_qd_out;
};


void apply_shape_matching_particle_gather_uniform8_a9a23521_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_apply_shape_matching_particle_gather_uniform8_a9a23521 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q_init = _wp_args->particle_q_init;
    ...
    wp::array_t<wp::int32> var_particle_cluster_offsets = _wp_args->particle_cluster_offsets;
    wp::array_t<wp::int32> var_particle_cluster_indices = _wp_args->particle_cluster_indices;
    wp::array_t<wp::int32> var_particle_cluster_member_offsets = _wp_args->particle_cluster_member_offsets;
    wp::array_t<wp::vec_t<3, wp::float32>> var_rest_local_positions_by_slot = _wp_args->rest_local_positions_by_slot;
    wp::array_t<wp::vec_t<3, wp::float32>> var_rest_local_template = _wp_args->rest_local_template;
    wp::array_t<wp::float32> var_coefficients = _wp_args->coefficients;
    wp::array_t<wp::int32> var_cluster_active = _wp_args->cluster_active;
    wp::array_t<wp::float32> var_particle_cluster_inv_weights = _wp_args->particle_cluster_inv_weights;
    wp::int32 var_cluster_count = _wp_args->cluster_count;
    wp::int32 var_use_rest_local_template = _wp_args->use_rest_local_template;
    wp::float32 var_stiffness = _wp_args->stiffness;
    wp::array_t<wp::quat_t<wp::float32>> var_cluster_rotations = _wp_args->cluster_rotations;
    wp::array_t<wp::vec_t<3, wp::float32>> var_cluster_translations = _wp_args->cluster_translations;
    wp::int32 var_include_base_delta = _wp_args->include_base_delta;
    wp::float32 var_dt = _wp_args->dt;
    wp::float32 var_v_max = _wp_args->v_max;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q_out = _wp_args->particle_q_out;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_qd_out = _wp_args->particle_qd_out;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
...
WP_API void apply_shape_matching_particle_gather_uniform8_a9a23521_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_apply_shape_matching_particle_gather_uniform8_a9a23521 *_wp_args)
{
    ...
    {
        apply_shape_matching_particle_gather_uniform8_a9a23521_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_solve_shape_matching_clusters_uniform27_colored_gs_ef0da61e {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> color_cluster_indices;
    ...
    wp::float32 stiffness;
    wp::float32 support_alpha;
    wp::int32 rotation_iterations;
    wp::array_t<wp::quat_t<wp::float32>> cluster_rotations;
};


void solve_shape_matching_clusters_uniform27_colored_gs_ef0da61e_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_solve_shape_matching_clusters_uniform27_colored_gs_ef0da61e *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    wp::array_t<wp::float32> var_particle_inv_mass = _wp_args->particle_inv_mass;
    wp::array_t<wp::int32> var_particle_flags = _wp_args->particle_flags;
    wp::array_t<wp::int32> var_color_cluster_indices = _wp_args->color_cluster_indices;
    ...
    wp::int32 var_cluster_count = _wp_args->cluster_count;
    wp::int32 var_use_rest_local_template = _wp_args->use_rest_local_template;
    wp::int32 var_color_start = _wp_args->color_start;
    wp::float32 var_stiffness = _wp_args->stiffness;
    wp::float32 var_support_alpha = _wp_args->support_alpha;
    wp::int32 var_rotation_iterations = _wp_args->rotation_iterations;
    wp::array_t<wp::quat_t<wp::float32>> var_cluster_rotations = _wp_args->cluster_rotations;
    //---------
    // primal vars
    wp::int32 var_0;
...
// Python CPU entry points
WP_API void solve_shape_matching_clusters_uniform27_colored_gs_ef0da61e_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_solve_shape_matching_clusters_uniform27_colored_gs_ef0da61e *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        solve_shape_matching_clusters_uniform27_colored_gs_ef0da61e_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_solve_shape_matching_clusters_uniform8_colored_gs_12229cc9 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> color_cluster_indices;
...
void solve_shape_matching_clusters_uniform8_colored_gs_12229cc9_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_solve_shape_matching_clusters_uniform8_colored_gs_12229cc9 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
...
// Python CPU entry points
WP_API void solve_shape_matching_clusters_uniform8_colored_gs_12229cc9_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_solve_shape_matching_clusters_uniform8_colored_gs_12229cc9 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        solve_shape_matching_clusters_uniform8_colored_gs_12229cc9_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_solve_shape_matching_clusters_uniform125_389d4cf6 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> indices_by_slot;
...
void solve_shape_matching_clusters_uniform125_389d4cf6_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_solve_shape_matching_clusters_uniform125_389d4cf6 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
...
// Python CPU entry points
WP_API void solve_shape_matching_clusters_uniform125_389d4cf6_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_solve_shape_matching_clusters_uniform125_389d4cf6 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        solve_shape_matching_clusters_uniform125_389d4cf6_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_compute_l0_runtime_active_kernel_df5f3df5 {
    wp::array_t<wp::int32> l0_active;
    wp::array_t<wp::int32> l0_source_cell;
    wp::array_t<wp::int32> l1_cell_to_cluster;
    wp::array_t<wp::int32> l1_projection_active;
    wp::int32 has_l1_projection;
    wp::array_t<wp::int32> l2_cell_to_cluster;
    wp::array_t<wp::int32> l2_projection_active;
    wp::int32 has_l2_projection;
    wp::array_t<wp::int32> runtime_active;
    wp::array_t<wp::int32> sleeping_count;
};


void compute_l0_runtime_active_kernel_df5f3df5_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_compute_l0_runtime_active_kernel_df5f3df5 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_l0_active = _wp_args->l0_active;
    wp::array_t<wp::int32> var_l0_source_cell = _wp_args->l0_source_cell;
    wp::array_t<wp::int32> var_l1_cell_to_cluster = _wp_args->l1_cell_to_cluster;
    wp::array_t<wp::int32> var_l1_projection_active = _wp_args->l1_projection_active;
    wp::int32 var_has_l1_projection = _wp_args->has_l1_projection;
    wp::array_t<wp::int32> var_l2_cell_to_cluster = _wp_args->l2_cell_to_cluster;
    wp::array_t<wp::int32> var_l2_projection_active = _wp_args->l2_projection_active;
    wp::int32 var_has_l2_projection = _wp_args->has_l2_projection;
    wp::array_t<wp::int32> var_runtime_active = _wp_args->runtime_active;
    wp::array_t<wp::int32> var_sleeping_count = _wp_args->sleeping_count;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
...
// Python CPU entry points
WP_API void compute_l0_runtime_active_kernel_df5f3df5_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_compute_l0_runtime_active_kernel_df5f3df5 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        compute_l0_runtime_active_kernel_df5f3df5_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_solve_shape_matching_clusters_uniform8_colored_gs_template_active_79bf4da3 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::int32> color_cluster_indices;
    wp::array_t<wp::int32> indices_by_slot;
    wp::array_t<wp::vec_t<3, wp::float32>> rest_local_template;
...
void solve_shape_matching_clusters_uniform8_colored_gs_template_active_79bf4da3_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_solve_shape_matching_clusters_uniform8_colored_gs_template_active_79bf4da3 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
...
// Python CPU entry points
WP_API void solve_shape_matching_clusters_uniform8_colored_gs_template_active_79bf4da3_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_solve_shape_matching_clusters_uniform8_colored_gs_template_active_79bf4da3 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        solve_shape_matching_clusters_uniform8_colored_gs_template_active_79bf4da3_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_solve_shape_matching_clusters_uniform125_colored_gs_7be93f58 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> color_cluster_indices;
...
void solve_shape_matching_clusters_uniform125_colored_gs_7be93f58_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_solve_shape_matching_clusters_uniform125_colored_gs_7be93f58 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
...
// Python CPU entry points
WP_API void solve_shape_matching_clusters_uniform125_colored_gs_7be93f58_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_solve_shape_matching_clusters_uniform125_colored_gs_7be93f58 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        solve_shape_matching_clusters_uniform125_colored_gs_7be93f58_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_solve_shape_matching_clusters_uniform8_template_active_9e18c4c0 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::int32> indices_by_slot;
    wp::array_t<wp::vec_t<3, wp::float32>> rest_local_template;
    wp::array_t<wp::float32> coefficients;
...
void solve_shape_matching_clusters_uniform8_template_active_9e18c4c0_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_solve_shape_matching_clusters_uniform8_template_active_9e18c4c0 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
...
// Python CPU entry points
WP_API void solve_shape_matching_clusters_uniform8_template_active_9e18c4c0_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_solve_shape_matching_clusters_uniform8_template_active_9e18c4c0 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        solve_shape_matching_clusters_uniform8_template_active_9e18c4c0_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_compute_coarse_sleep_projection_kernel_2836d096 {
    wp::array_t<wp::int32> cluster_active;
    wp::array_t<wp::int32> block_keys;
    wp::array_t<wp::int32> sleepable;
    wp::array_t<wp::int32> wake_mask;
    wp::int32 level_enabled;
    wp::array_t<wp::int32> projection_active;
    wp::array_t<wp::int32> projection_count;
};


void compute_coarse_sleep_projection_kernel_2836d096_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_compute_coarse_sleep_projection_kernel_2836d096 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cluster_active = _wp_args->cluster_active;
    wp::array_t<wp::int32> var_block_keys = _wp_args->block_keys;
    wp::array_t<wp::int32> var_sleepable = _wp_args->sleepable;
    wp::array_t<wp::int32> var_wake_mask = _wp_args->wake_mask;
    wp::int32 var_level_enabled = _wp_args->level_enabled;
    wp::array_t<wp::int32> var_projection_active = _wp_args->projection_active;
    wp::array_t<wp::int32> var_projection_count = _wp_args->projection_count;
    //---------
    // primal vars
    wp::int32 var_0;
...
// Python CPU entry points
WP_API void compute_coarse_sleep_projection_kernel_2836d096_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_compute_coarse_sleep_projection_kernel_2836d096 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        compute_coarse_sleep_projection_kernel_2836d096_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_finalize_position_update_from_q_15fc23c4 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q_init;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
...
void finalize_position_update_from_q_15fc23c4_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_finalize_position_update_from_q_15fc23c4 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q_init = _wp_args->particle_q_init;
...
// Python CPU entry points
WP_API void finalize_position_update_from_q_15fc23c4_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_finalize_position_update_from_q_15fc23c4 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        finalize_position_update_from_q_15fc23c4_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_solve_shape_matching_clusters_uniform8_512c1454 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> indices_by_slot;
...
void solve_shape_matching_clusters_uniform8_512c1454_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_solve_shape_matching_clusters_uniform8_512c1454 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
...
// Python CPU entry points
WP_API void solve_shape_matching_clusters_uniform8_512c1454_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_solve_shape_matching_clusters_uniform8_512c1454 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        solve_shape_matching_clusters_uniform8_512c1454_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_solve_volume_constraints_uniform8_835d9c71 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> indices_by_slot;
...
void solve_volume_constraints_uniform8_835d9c71_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_solve_volume_constraints_uniform8_835d9c71 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
...
// Python CPU entry points
WP_API void solve_volume_constraints_uniform8_835d9c71_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_solve_volume_constraints_uniform8_835d9c71 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        solve_volume_constraints_uniform8_835d9c71_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_compute_shape_matching_cluster_poses_uniform8_a8cd20e1 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> indices_by_slot;
    wp::array_t<wp::vec_t<3, wp::float32>> rest_local_positions_by_slot;
...
void compute_shape_matching_cluster_poses_uniform8_a8cd20e1_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_compute_shape_matching_cluster_poses_uniform8_a8cd20e1 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
...
// Python CPU entry points
WP_API void compute_shape_matching_cluster_poses_uniform8_a8cd20e1_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_compute_shape_matching_cluster_poses_uniform8_a8cd20e1 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        compute_shape_matching_cluster_poses_uniform8_a8cd20e1_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_prolongate_shape_matching_corrections_uniform8_529dc364 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q_init;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_qd;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::vec_t<3, wp::float32>> coarse_q_snapshot;
    wp::array_t<wp::int32> child_cluster;
    wp::array_t<wp::int32> block_keys;
    wp::array_t<wp::int32> node_grid_xyz;
    wp::array_t<wp::int32> grid_to_node;
    wp::int32 block_size;
    wp::int32 max_grid_x;
    wp::int32 max_grid_y;
    wp::int32 max_grid_z;
    wp::array_t<wp::int32> cluster_active;
    wp::int32 absolute_projection;
    wp::float32 dt;
    wp::float32 v_max;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q_out;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_qd_out;
...
void prolongate_shape_matching_corrections_uniform8_529dc364_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_prolongate_shape_matching_corrections_uniform8_529dc364 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q_init = _wp_args->particle_q_init;
    ...
    wp::array_t<wp::float32> var_particle_inv_mass = _wp_args->particle_inv_mass;
    wp::array_t<wp::int32> var_particle_flags = _wp_args->particle_flags;
    wp::array_t<wp::vec_t<3, wp::float32>> var_coarse_q_snapshot = _wp_args->coarse_q_snapshot;
    wp::array_t<wp::int32> var_child_cluster = _wp_args->child_cluster;
    wp::array_t<wp::int32> var_block_keys = _wp_args->block_keys;
    wp::array_t<wp::int32> var_node_grid_xyz = _wp_args->node_grid_xyz;
    wp::array_t<wp::int32> var_grid_to_node = _wp_args->grid_to_node;
    wp::int32 var_block_size = _wp_args->block_size;
    wp::int32 var_max_grid_x = _wp_args->max_grid_x;
    wp::int32 var_max_grid_y = _wp_args->max_grid_y;
    wp::int32 var_max_grid_z = _wp_args->max_grid_z;
    wp::array_t<wp::int32> var_cluster_active = _wp_args->cluster_active;
    wp::int32 var_absolute_projection = _wp_args->absolute_projection;
    wp::float32 var_dt = _wp_args->dt;
    wp::float32 var_v_max = _wp_args->v_max;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q_out = _wp_args->particle_q_out;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_qd_out = _wp_args->particle_qd_out;
...
// Python CPU entry points
WP_API void prolongate_shape_matching_corrections_uniform8_529dc364_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_prolongate_shape_matching_corrections_uniform8_529dc364 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        prolongate_shape_matching_corrections_uniform8_529dc364_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_accumulate_runtime_cluster_counts_kernel_e9a047b9 {
    wp::array_t<wp::int32> cluster_active;
    wp::array_t<wp::int32> cluster_offsets;
    wp::array_t<wp::int32> cluster_indices;
    wp::array_t<wp::int32> particle_cluster_counts;
};


void accumulate_runtime_cluster_counts_kernel_e9a047b9_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_accumulate_runtime_cluster_counts_kernel_e9a047b9 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cluster_active = _wp_args->cluster_active;
    wp::array_t<wp::int32> var_cluster_offsets = _wp_args->cluster_offsets;
    wp::array_t<wp::int32> var_cluster_indices = _wp_args->cluster_indices;
    wp::array_t<wp::int32> var_particle_cluster_counts = _wp_args->particle_cluster_counts;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
...
// Python CPU entry points
WP_API void accumulate_runtime_cluster_counts_kernel_e9a047b9_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_accumulate_runtime_cluster_counts_kernel_e9a047b9 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        accumulate_runtime_cluster_counts_kernel_e9a047b9_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_project_shape_matching_children_uniform8_0b6b710a {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q_init;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_qd;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> awake_l0_cluster_counts;
    wp::array_t<wp::int32> child_cluster;
    wp::array_t<wp::int32> block_keys;
    wp::array_t<wp::int32> node_grid_xyz;
    wp::array_t<wp::int32> grid_to_node;
    ...
    wp::int32 max_grid_z;
    wp::array_t<wp::int32> projection_active;
    wp::float32 projection_stiffness;
    wp::float32 dt;
    wp::float32 v_max;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q_out;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_qd_out;
...
void project_shape_matching_children_uniform8_0b6b710a_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_project_shape_matching_children_uniform8_0b6b710a *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q_init = _wp_args->particle_q_init;
    ...
    wp::array_t<wp::float32> var_particle_inv_mass = _wp_args->particle_inv_mass;
    wp::array_t<wp::int32> var_particle_flags = _wp_args->particle_flags;
    wp::array_t<wp::int32> var_awake_l0_cluster_counts = _wp_args->awake_l0_cluster_counts;
    wp::array_t<wp::int32> var_child_cluster = _wp_args->child_cluster;
    wp::array_t<wp::int32> var_block_keys = _wp_args->block_keys;
    wp::array_t<wp::int32> var_node_grid_xyz = _wp_args->node_grid_xyz;
    wp::array_t<wp::int32> var_grid_to_node = _wp_args->grid_to_node;
    ...
    wp::int32 var_max_grid_z = _wp_args->max_grid_z;
    wp::array_t<wp::int32> var_projection_active = _wp_args->projection_active;
    wp::float32 var_projection_stiffness = _wp_args->projection_stiffness;
    wp::float32 var_dt = _wp_args->dt;
    wp::float32 var_v_max = _wp_args->v_max;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q_out = _wp_args->particle_q_out;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_qd_out = _wp_args->particle_qd_out;
...
// Python CPU entry points
WP_API void project_shape_matching_children_uniform8_0b6b710a_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_project_shape_matching_children_uniform8_0b6b710a *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        project_shape_matching_children_uniform8_0b6b710a_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_mark_wake_blocks_from_deleted_cells_kernel_b4b937be {
    wp::array_t<wp::int32> deleted_cells;
    wp::array_t<wp::int32> deleted_count;
    wp::int32 num_cells;
    wp::array_t<wp::int32> cell_to_cluster;
    wp::array_t<wp::int32> block_keys;
    wp::int32 wake_halo_blocks;
    wp::array_t<wp::int32> wake_mask;
};


void mark_wake_blocks_from_deleted_cells_kernel_b4b937be_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_mark_wake_blocks_from_deleted_cells_kernel_b4b937be *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_deleted_cells = _wp_args->deleted_cells;
    wp::array_t<wp::int32> var_deleted_count = _wp_args->deleted_count;
    wp::int32 var_num_cells = _wp_args->num_cells;
    wp::array_t<wp::int32> var_cell_to_cluster = _wp_args->cell_to_cluster;
    wp::array_t<wp::int32> var_block_keys = _wp_args->block_keys;
    wp::int32 var_wake_halo_blocks = _wp_args->wake_halo_blocks;
    wp::array_t<wp::int32> var_wake_mask = _wp_args->wake_mask;
    //---------
    // primal vars
    wp::int32 var_0;
...
// Python CPU entry points
WP_API void mark_wake_blocks_from_deleted_cells_kernel_b4b937be_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_mark_wake_blocks_from_deleted_cells_kernel_b4b937be *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        mark_wake_blocks_from_deleted_cells_kernel_b4b937be_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_prolongate_shape_matching_corrections_uniform8_table_1edb0e67 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q_init;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_qd;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::vec_t<3, wp::float32>> coarse_q_snapshot;
    wp::array_t<wp::int32> parent_indices;
    wp::array_t<wp::float32> parent_weights;
    wp::array_t<wp::int32> child_cluster;
    wp::array_t<wp::int32> cluster_active;
    wp::int32 absolute_projection;
    wp::float32 dt;
...
void prolongate_shape_matching_corrections_uniform8_table_1edb0e67_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_prolongate_shape_matching_corrections_uniform8_table_1edb0e67 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q_init = _wp_args->particle_q_init;
    ...
    wp::array_t<wp::int32> var_particle_flags = _wp_args->particle_flags;
    wp::array_t<wp::vec_t<3, wp::float32>> var_coarse_q_snapshot = _wp_args->coarse_q_snapshot;
    wp::array_t<wp::int32> var_parent_indices = _wp_args->parent_indices;
    wp::array_t<wp::float32> var_parent_weights = _wp_args->parent_weights;
    wp::array_t<wp::int32> var_child_cluster = _wp_args->child_cluster;
    wp::array_t<wp::int32> var_cluster_active = _wp_args->cluster_active;
    wp::int32 var_absolute_projection = _wp_args->absolute_projection;
    wp::float32 var_dt = _wp_args->dt;
...
// Python CPU entry points
WP_API void prolongate_shape_matching_corrections_uniform8_table_1edb0e67_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_prolongate_shape_matching_corrections_uniform8_table_1edb0e67 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        prolongate_shape_matching_corrections_uniform8_table_1edb0e67_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_project_shape_matching_children_uniform8_table_bee52543 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q_init;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_qd;
    wp::array_t<wp::float32> particle_inv_mass;
...
void project_shape_matching_children_uniform8_table_bee52543_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_project_shape_matching_children_uniform8_table_bee52543 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q_init = _wp_args->particle_q_init;
...
// Python CPU entry points
WP_API void project_shape_matching_children_uniform8_table_bee52543_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_project_shape_matching_children_uniform8_table_bee52543 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        project_shape_matching_children_uniform8_table_bee52543_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_mask_l1_projection_covered_by_l2_kernel_b02a0d30 {
    wp::array_t<wp::int32> l1_source_cell;
    wp::array_t<wp::int32> l2_cell_to_cluster;
    wp::array_t<wp::int32> l2_projection_active;
    wp::array_t<wp::int32> l1_projection_active;
    wp::array_t<wp::int32> l1_projection_count;
};


void mask_l1_projection_covered_by_l2_kernel_b02a0d30_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_mask_l1_projection_covered_by_l2_kernel_b02a0d30 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_l1_source_cell = _wp_args->l1_source_cell;
    wp::array_t<wp::int32> var_l2_cell_to_cluster = _wp_args->l2_cell_to_cluster;
    wp::array_t<wp::int32> var_l2_projection_active = _wp_args->l2_projection_active;
    wp::array_t<wp::int32> var_l1_projection_active = _wp_args->l1_projection_active;
    wp::array_t<wp::int32> var_l1_projection_count = _wp_args->l1_projection_count;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
...
// Python CPU entry points
WP_API void mask_l1_projection_covered_by_l2_kernel_b02a0d30_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_mask_l1_projection_covered_by_l2_kernel_b02a0d30 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        mask_l1_projection_covered_by_l2_kernel_b02a0d30_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_solve_shape_matching_clusters_uniform27_c0cd2af0 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> indices_by_slot;
...
void solve_shape_matching_clusters_uniform27_c0cd2af0_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_solve_shape_matching_clusters_uniform27_c0cd2af0 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
...
// Python CPU entry points
WP_API void solve_shape_matching_clusters_uniform27_c0cd2af0_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_solve_shape_matching_clusters_uniform27_c0cd2af0 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        solve_shape_matching_clusters_uniform27_c0cd2af0_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_finalize_runtime_cluster_inv_weights_kernel_e7131549 {
    wp::array_t<wp::int32> particle_cluster_counts;
    wp::array_t<wp::float32> particle_cluster_inv_weights;
};


void finalize_runtime_cluster_inv_weights_kernel_e7131549_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_finalize_runtime_cluster_inv_weights_kernel_e7131549 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_particle_cluster_counts = _wp_args->particle_cluster_counts;
...
// Python CPU entry points
WP_API void finalize_runtime_cluster_inv_weights_kernel_e7131549_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_finalize_runtime_cluster_inv_weights_kernel_e7131549 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        finalize_runtime_cluster_inv_weights_kernel_e7131549_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
