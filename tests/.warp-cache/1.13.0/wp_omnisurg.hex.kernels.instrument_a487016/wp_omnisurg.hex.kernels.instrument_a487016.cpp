...
static wp::float32 _active_particle_inv_mass_0(
...
static wp::float32 _cell_inv_mass_sum_0(
...
static wp::vec_t<3, wp::float32> _sphere_triangle_fallback_dir_0(
...
static void _scatter_cell_correction_to_nodes_0(
    wp::int32 var_cell_index,
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/instrument.py:13
static void adj__active_particle_inv_mass_0(
    wp::int32 var_particle_index,
    wp::array_t<wp::float32> var_particle_inv_mass,
    wp::array_t<wp::int32> var_particle_flags,
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/instrument.py:29
static void adj__cell_inv_mass_sum_0(
    wp::int32 var_cell_index,
    wp::array_t<wp::int32> var_cell_nodes,
    wp::array_t<wp::int32> var_cell_active,
    wp::array_t<wp::float32> var_particle_inv_mass,
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/instrument.py:48
static void adj__sphere_triangle_fallback_dir_0(
    wp::vec_t<3, wp::float32> var_v0,
    wp::vec_t<3, wp::float32> var_v1,
    wp::vec_t<3, wp::float32> var_v2,
    wp::vec_t<3, wp::float32> var_contact_point,
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/instrument.py:79
static void adj__scatter_cell_correction_to_nodes_0(
    wp::int32 var_cell_index,
    wp::vec_t<3, wp::float32> var_correction,
    wp::float32 var_cell_weight,
    wp::array_t<wp::int32> var_cell_nodes,
...
struct wp_args_apply_kinematic_sphere_mc_triangle_node_deltas_kernel_2c1ddbb7 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_delta_accumulator;
    wp::array_t<wp::int32> particle_delta_counter;
};


void apply_kinematic_sphere_mc_triangle_node_deltas_kernel_2c1ddbb7_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_apply_kinematic_sphere_mc_triangle_node_deltas_kernel_2c1ddbb7 *_wp_args)
{
    //---------
    // argument vars
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_delta_accumulator = _wp_args->particle_delta_accumulator;
    wp::array_t<wp::int32> var_particle_delta_counter = _wp_args->particle_delta_counter;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::float32 var_1;
...
WP_API void apply_kinematic_sphere_mc_triangle_node_deltas_kernel_2c1ddbb7_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_apply_kinematic_sphere_mc_triangle_node_deltas_kernel_2c1ddbb7 *_wp_args)
{
    ...
    {
        apply_kinematic_sphere_mc_triangle_node_deltas_kernel_2c1ddbb7_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_project_kinematic_sphere_particle_positions_kernel_6717a775 {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::float32> particle_radius;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::vec_t<3, wp::float32>> sphere_q_prev;
    wp::array_t<wp::vec_t<3, wp::float32>> sphere_q;
    wp::int32 sphere_count;
    wp::float32 sphere_radius;
    wp::float32 interpolation_alpha;
    wp::float32 relaxation;
    wp::float32 max_correction;
};


void project_kinematic_sphere_particle_positions_kernel_6717a775_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_project_kinematic_sphere_particle_positions_kernel_6717a775 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    ...
    wp::array_t<wp::int32> var_particle_flags = _wp_args->particle_flags;
    wp::array_t<wp::vec_t<3, wp::float32>> var_sphere_q_prev = _wp_args->sphere_q_prev;
    ...
    wp::float32 var_interpolation_alpha = _wp_args->interpolation_alpha;
    wp::float32 var_relaxation = _wp_args->relaxation;
    wp::float32 var_max_correction = _wp_args->max_correction;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
...
// Python CPU entry points
WP_API void project_kinematic_sphere_particle_positions_kernel_6717a775_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_project_kinematic_sphere_particle_positions_kernel_6717a775 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        project_kinematic_sphere_particle_positions_kernel_6717a775_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_project_kinematic_sphere_mc_triangle_node_positions_kernel_5af77c50 {
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
...
void project_kinematic_sphere_mc_triangle_node_positions_kernel_5af77c50_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_project_kinematic_sphere_mc_triangle_node_positions_kernel_5af77c50 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::float32> var_particle_inv_mass = _wp_args->particle_inv_mass;
    ...
    wp::int32 var_triangle_count = _wp_args->triangle_count;
    wp::array_t<wp::vec_t<3, wp::float32>> var_sphere_q_prev = _wp_args->sphere_q_prev;
    wp::array_t<wp::vec_t<3, wp::float32>> var_sphere_q = _wp_args->sphere_q;
    wp::int32 var_sphere_count = _wp_args->sphere_count;
    wp::float32 var_sphere_radius = _wp_args->sphere_radius;
...
// Python CPU entry points
WP_API void project_kinematic_sphere_mc_triangle_node_positions_kernel_5af77c50_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_project_kinematic_sphere_mc_triangle_node_positions_kernel_5af77c50 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        project_kinematic_sphere_mc_triangle_node_positions_kernel_5af77c50_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
