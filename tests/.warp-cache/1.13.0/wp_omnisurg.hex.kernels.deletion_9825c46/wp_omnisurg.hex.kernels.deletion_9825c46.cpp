...
static wp::float32 _point_segment_distance_sq_0(
...
static wp::float32 _point_triangle_distance_sq_0(
    wp::vec_t<3, wp::float32> var_p,
    wp::vec_t<3, wp::float32> var_a,
    wp::vec_t<3, wp::float32> var_b,
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/deletion.py:364
static void adj__point_segment_distance_sq_0(
    wp::vec_t<3, wp::float32> var_p,
    wp::vec_t<3, wp::float32> var_a,
    wp::vec_t<3, wp::float32> var_b,
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/kernels/deletion.py:382
static void adj__point_triangle_distance_sq_0(
    wp::vec_t<3, wp::float32> var_p,
    wp::vec_t<3, wp::float32> var_a,
    wp::vec_t<3, wp::float32> var_b,
    wp::vec_t<3, wp::float32> var_c,
...
struct wp_args_validate_node_state_kernel_b94a5c4e {
    wp::array_t<wp::int32> node_support_count;
    wp::array_t<wp::float32> node_mass;
    wp::array_t<wp::int32> locked_node_mask;
    wp::array_t<wp::float32> particle_mass;
    wp::array_t<wp::float32> particle_inv_mass;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> error_count;
    wp::array_t<wp::int32> first_error;
};


void validate_node_state_kernel_b94a5c4e_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_validate_node_state_kernel_b94a5c4e *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_node_support_count = _wp_args->node_support_count;
    wp::array_t<wp::float32> var_node_mass = _wp_args->node_mass;
    wp::array_t<wp::int32> var_locked_node_mask = _wp_args->locked_node_mask;
    wp::array_t<wp::float32> var_particle_mass = _wp_args->particle_mass;
    ...
    wp::array_t<wp::int32> var_error_count = _wp_args->error_count;
    wp::array_t<wp::int32> var_first_error = _wp_args->first_error;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
...
void validate_node_state_kernel_b94a5c4e_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_validate_node_state_kernel_b94a5c4e *_wp_args,
    wp_args_validate_node_state_kernel_b94a5c4e *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_node_support_count = _wp_args->node_support_count;
    ...
    wp::array_t<wp::int32> var_error_count = _wp_args->error_count;
    wp::array_t<wp::int32> var_first_error = _wp_args->first_error;
    wp::array_t<wp::int32> adj_node_support_count = _wp_adj_args->node_support_count;
    wp::array_t<wp::float32> adj_node_mass = _wp_adj_args->node_mass;
    wp::array_t<wp::int32> adj_locked_node_mask = _wp_adj_args->locked_node_mask;
    wp::array_t<wp::float32> adj_particle_mass = _wp_adj_args->particle_mass;
    wp::array_t<wp::float32> adj_particle_inv_mass = _wp_adj_args->particle_inv_mass;
    wp::array_t<wp::int32> adj_particle_flags = _wp_adj_args->particle_flags;
    wp::array_t<wp::int32> adj_error_count = _wp_adj_args->error_count;
    wp::array_t<wp::int32> adj_first_error = _wp_adj_args->first_error;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
...
WP_API void validate_node_state_kernel_b94a5c4e_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_validate_node_state_kernel_b94a5c4e *_wp_args)
{
    ...
    {
        validate_node_state_kernel_b94a5c4e_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void validate_node_state_kernel_b94a5c4e_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_validate_node_state_kernel_b94a5c4e *_wp_args,
    wp_args_validate_node_state_kernel_b94a5c4e *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        validate_node_state_kernel_b94a5c4e_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_delete_cells_sparse_kernel_b7ec3e34 {
    wp::array_t<wp::int32> cell_ids;
    wp::int32 candidate_capacity;
    wp::array_t<wp::int32> candidate_count;
    wp::int32 num_cells;
    wp::array_t<wp::int32> cell_nodes;
    wp::array_t<wp::float32> cell_mass;
    wp::array_t<wp::int32> cell_active;
    wp::array_t<wp::int32> node_support_count;
    wp::array_t<wp::float32> node_mass;
    wp::array_t<wp::int32> deleted_cells;
    wp::array_t<wp::int32> deleted_count;
    wp::array_t<wp::int32> deleted_total;
};


void delete_cells_sparse_kernel_b7ec3e34_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_delete_cells_sparse_kernel_b7ec3e34 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cell_ids = _wp_args->cell_ids;
    wp::int32 var_candidate_capacity = _wp_args->candidate_capacity;
    wp::array_t<wp::int32> var_candidate_count = _wp_args->candidate_count;
    wp::int32 var_num_cells = _wp_args->num_cells;
    wp::array_t<wp::int32> var_cell_nodes = _wp_args->cell_nodes;
    wp::array_t<wp::float32> var_cell_mass = _wp_args->cell_mass;
    ...
    wp::array_t<wp::int32> var_deleted_total = _wp_args->deleted_total;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
...
void delete_cells_sparse_kernel_b7ec3e34_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_delete_cells_sparse_kernel_b7ec3e34 *_wp_args,
    wp_args_delete_cells_sparse_kernel_b7ec3e34 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cell_ids = _wp_args->cell_ids;
    ...
    wp::array_t<wp::int32> var_deleted_count = _wp_args->deleted_count;
    wp::array_t<wp::int32> var_deleted_total = _wp_args->deleted_total;
    wp::array_t<wp::int32> adj_cell_ids = _wp_adj_args->cell_ids;
    wp::int32 adj_candidate_capacity = _wp_adj_args->candidate_capacity;
    wp::array_t<wp::int32> adj_candidate_count = _wp_adj_args->candidate_count;
    wp::int32 adj_num_cells = _wp_adj_args->num_cells;
    wp::array_t<wp::int32> adj_cell_nodes = _wp_adj_args->cell_nodes;
    wp::array_t<wp::float32> adj_cell_mass = _wp_adj_args->cell_mass;
    wp::array_t<wp::int32> adj_cell_active = _wp_adj_args->cell_active;
    wp::array_t<wp::int32> adj_node_support_count = _wp_adj_args->node_support_count;
    wp::array_t<wp::float32> adj_node_mass = _wp_adj_args->node_mass;
    wp::array_t<wp::int32> adj_deleted_cells = _wp_adj_args->deleted_cells;
    wp::array_t<wp::int32> adj_deleted_count = _wp_adj_args->deleted_count;
    wp::array_t<wp::int32> adj_deleted_total = _wp_adj_args->deleted_total;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
...
// Python CPU entry points
WP_API void delete_cells_sparse_kernel_b7ec3e34_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_delete_cells_sparse_kernel_b7ec3e34 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        delete_cells_sparse_kernel_b7ec3e34_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void delete_cells_sparse_kernel_b7ec3e34_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_delete_cells_sparse_kernel_b7ec3e34 *_wp_args,
    wp_args_delete_cells_sparse_kernel_b7ec3e34 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        delete_cells_sparse_kernel_b7ec3e34_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_deactivate_deleted_cell_clusters_kernel_2a33aef6 {
    wp::array_t<wp::int32> deleted_cells;
    wp::array_t<wp::int32> deleted_count;
    wp::int32 num_cells;
    ...
    wp::array_t<wp::int32> deactivated_cluster_ids;
    wp::array_t<wp::int32> deactivated_count;
};


void deactivate_deleted_cell_clusters_kernel_2a33aef6_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_deactivate_deleted_cell_clusters_kernel_2a33aef6 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_deleted_cells = _wp_args->deleted_cells;
    ...
    wp::array_t<wp::int32> var_deactivated_cluster_ids = _wp_args->deactivated_cluster_ids;
    wp::array_t<wp::int32> var_deactivated_count = _wp_args->deactivated_count;
    //---------
    // primal vars
    wp::int32 var_0;
...
void deactivate_deleted_cell_clusters_kernel_2a33aef6_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_deactivate_deleted_cell_clusters_kernel_2a33aef6 *_wp_args,
    wp_args_deactivate_deleted_cell_clusters_kernel_2a33aef6 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_deleted_cells = _wp_args->deleted_cells;
    ...
    wp::array_t<wp::int32> adj_deleted_count = _wp_adj_args->deleted_count;
    wp::int32 adj_num_cells = _wp_adj_args->num_cells;
    wp::array_t<wp::int32> adj_cell_to_cluster = _wp_adj_args->cell_to_cluster;
    wp::array_t<wp::int32> adj_cluster_active = _wp_adj_args->cluster_active;
    wp::array_t<wp::int32> adj_cluster_offsets = _wp_adj_args->cluster_offsets;
    wp::array_t<wp::int32> adj_cluster_indices = _wp_adj_args->cluster_indices;
    wp::array_t<wp::int32> adj_particle_cluster_counts = _wp_adj_args->particle_cluster_counts;
    wp::array_t<wp::int32> adj_deactivated_cluster_ids = _wp_adj_args->deactivated_cluster_ids;
    wp::array_t<wp::int32> adj_deactivated_count = _wp_adj_args->deactivated_count;
    //---------
    // primal vars
    wp::int32 var_0;
    const wp::int32 var_1 = 0;
...
// Python CPU entry points
WP_API void deactivate_deleted_cell_clusters_kernel_2a33aef6_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_deactivate_deleted_cell_clusters_kernel_2a33aef6 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        deactivate_deleted_cell_clusters_kernel_2a33aef6_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void deactivate_deleted_cell_clusters_kernel_2a33aef6_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_deactivate_deleted_cell_clusters_kernel_2a33aef6 *_wp_args,
    wp_args_deactivate_deleted_cell_clusters_kernel_2a33aef6 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        deactivate_deleted_cell_clusters_kernel_2a33aef6_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_select_sphere_particle_contact_cells_kernel_33f06896 {
    wp::int32 num_cells;
    wp::array_t<wp::int32> cell_nodes;
    ...
    wp::array_t<wp::int32> sphere_cut_enabled;
...
void select_sphere_particle_contact_cells_kernel_33f06896_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_select_sphere_particle_contact_cells_kernel_33f06896 *_wp_args)
{
    //---------
    // argument vars
    wp::int32 var_num_cells = _wp_args->num_cells;
    ...
    wp::array_t<wp::int32> var_sphere_cut_enabled = _wp_args->sphere_cut_enabled;
...
void select_sphere_particle_contact_cells_kernel_33f06896_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_select_sphere_particle_contact_cells_kernel_33f06896 *_wp_args,
    wp_args_select_sphere_particle_contact_cells_kernel_33f06896 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::int32 var_num_cells = _wp_args->num_cells;
    ...
    wp::array_t<wp::float32> adj_particle_radius = _wp_adj_args->particle_radius;
    wp::array_t<wp::int32> adj_particle_flags = _wp_adj_args->particle_flags;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_sphere_q = _wp_adj_args->sphere_q;
    wp::array_t<wp::int32> adj_sphere_cut_enabled = _wp_adj_args->sphere_cut_enabled;
...
// Python CPU entry points
WP_API void select_sphere_particle_contact_cells_kernel_33f06896_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_select_sphere_particle_contact_cells_kernel_33f06896 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        select_sphere_particle_contact_cells_kernel_33f06896_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void select_sphere_particle_contact_cells_kernel_33f06896_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_select_sphere_particle_contact_cells_kernel_33f06896 *_wp_args,
    wp_args_select_sphere_particle_contact_cells_kernel_33f06896 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        select_sphere_particle_contact_cells_kernel_33f06896_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_validate_cluster_state_kernel_98ca18a5 {
    wp::array_t<wp::int32> cluster_active;
    wp::array_t<wp::int32> particle_cluster_counts;
...
void validate_cluster_state_kernel_98ca18a5_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_validate_cluster_state_kernel_98ca18a5 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cluster_active = _wp_args->cluster_active;
...
void validate_cluster_state_kernel_98ca18a5_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_validate_cluster_state_kernel_98ca18a5 *_wp_args,
    wp_args_validate_cluster_state_kernel_98ca18a5 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cluster_active = _wp_args->cluster_active;
    ...
    wp::array_t<wp::int32> adj_cluster_active = _wp_adj_args->cluster_active;
    wp::array_t<wp::int32> adj_particle_cluster_counts = _wp_adj_args->particle_cluster_counts;
    wp::array_t<wp::float32> adj_particle_cluster_inv_weights = _wp_adj_args->particle_cluster_inv_weights;
    wp::array_t<wp::int32> adj_error_count = _wp_adj_args->error_count;
    wp::array_t<wp::int32> adj_first_error = _wp_adj_args->first_error;
    //---------
    // primal vars
...
// Python CPU entry points
WP_API void validate_cluster_state_kernel_98ca18a5_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_validate_cluster_state_kernel_98ca18a5 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        validate_cluster_state_kernel_98ca18a5_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void validate_cluster_state_kernel_98ca18a5_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_validate_cluster_state_kernel_98ca18a5 *_wp_args,
    wp_args_validate_cluster_state_kernel_98ca18a5 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        validate_cluster_state_kernel_98ca18a5_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_select_ray_segment_cells_kernel_6e51a20c {
    wp::int32 num_cells;
    wp::array_t<wp::int32> cell_nodes;
    wp::array_t<wp::int32> cell_material;
    wp::array_t<wp::int32> cell_active;
    ...
    wp::int32 has_material_filter;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::int32> start_cell_ids;
    wp::vec_t<3, wp::float32> ray_dir;
    wp::float32 depth;
    wp::float32 padding;
    wp::array_t<wp::int32> selected_cells;
    wp::array_t<wp::int32> selected_count;
...
void select_ray_segment_cells_kernel_6e51a20c_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_select_ray_segment_cells_kernel_6e51a20c *_wp_args)
{
    //---------
    // argument vars
    wp::int32 var_num_cells = _wp_args->num_cells;
    ...
    wp::int32 var_has_material_filter = _wp_args->has_material_filter;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    wp::array_t<wp::int32> var_start_cell_ids = _wp_args->start_cell_ids;
    wp::vec_t<3, wp::float32> var_ray_dir = _wp_args->ray_dir;
    wp::float32 var_depth = _wp_args->depth;
    wp::float32 var_padding = _wp_args->padding;
    wp::array_t<wp::int32> var_selected_cells = _wp_args->selected_cells;
    wp::array_t<wp::int32> var_selected_count = _wp_args->selected_count;
    //---------
    // primal vars
...
void select_ray_segment_cells_kernel_6e51a20c_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_select_ray_segment_cells_kernel_6e51a20c *_wp_args,
    wp_args_select_ray_segment_cells_kernel_6e51a20c *_wp_adj_args)
{
    //---------
    // argument vars
    wp::int32 var_num_cells = _wp_args->num_cells;
    ...
    wp::int32 adj_has_material_filter = _wp_adj_args->has_material_filter;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_particle_q = _wp_adj_args->particle_q;
    wp::array_t<wp::int32> adj_start_cell_ids = _wp_adj_args->start_cell_ids;
    wp::vec_t<3, wp::float32> adj_ray_dir = _wp_adj_args->ray_dir;
    wp::float32 adj_depth = _wp_adj_args->depth;
    wp::float32 adj_padding = _wp_adj_args->padding;
    wp::array_t<wp::int32> adj_selected_cells = _wp_adj_args->selected_cells;
    wp::array_t<wp::int32> adj_selected_count = _wp_adj_args->selected_count;
    //---------
    // primal vars
...
// Python CPU entry points
WP_API void select_ray_segment_cells_kernel_6e51a20c_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_select_ray_segment_cells_kernel_6e51a20c *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        select_ray_segment_cells_kernel_6e51a20c_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void select_ray_segment_cells_kernel_6e51a20c_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_select_ray_segment_cells_kernel_6e51a20c *_wp_args,
    wp_args_select_ray_segment_cells_kernel_6e51a20c *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        select_ray_segment_cells_kernel_6e51a20c_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_deactivate_single_deleted_cell_cluster_kernel_f780ad66 {
    wp::array_t<wp::int32> deleted_cells;
    wp::array_t<wp::int32> deleted_count;
    wp::int32 num_cells;
    wp::array_t<wp::int32> cell_to_cluster;
...
void deactivate_single_deleted_cell_cluster_kernel_f780ad66_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_deactivate_single_deleted_cell_cluster_kernel_f780ad66 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_deleted_cells = _wp_args->deleted_cells;
...
void deactivate_single_deleted_cell_cluster_kernel_f780ad66_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_deactivate_single_deleted_cell_cluster_kernel_f780ad66 *_wp_args,
    wp_args_deactivate_single_deleted_cell_cluster_kernel_f780ad66 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_deleted_cells = _wp_args->deleted_cells;
...
// Python CPU entry points
WP_API void deactivate_single_deleted_cell_cluster_kernel_f780ad66_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_deactivate_single_deleted_cell_cluster_kernel_f780ad66 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        deactivate_single_deleted_cell_cluster_kernel_f780ad66_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void deactivate_single_deleted_cell_cluster_kernel_f780ad66_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_deactivate_single_deleted_cell_cluster_kernel_f780ad66 *_wp_args,
    wp_args_deactivate_single_deleted_cell_cluster_kernel_f780ad66 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        deactivate_single_deleted_cell_cluster_kernel_f780ad66_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_delete_single_cell_complete_kernel_0db01062 {
    wp::array_t<wp::int32> cell_ids;
    wp::int32 num_cells;
    wp::array_t<wp::int32> cell_nodes;
    wp::array_t<wp::float32> cell_mass;
...
void delete_single_cell_complete_kernel_0db01062_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_delete_single_cell_complete_kernel_0db01062 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cell_ids = _wp_args->cell_ids;
...
void delete_single_cell_complete_kernel_0db01062_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_delete_single_cell_complete_kernel_0db01062 *_wp_args,
    wp_args_delete_single_cell_complete_kernel_0db01062 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cell_ids = _wp_args->cell_ids;
...
// Python CPU entry points
WP_API void delete_single_cell_complete_kernel_0db01062_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_delete_single_cell_complete_kernel_0db01062 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        delete_single_cell_complete_kernel_0db01062_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void delete_single_cell_complete_kernel_0db01062_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_delete_single_cell_complete_kernel_0db01062 *_wp_args,
    wp_args_delete_single_cell_complete_kernel_0db01062 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        delete_single_cell_complete_kernel_0db01062_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_select_ray_surface_cells_kernel_b9b84ac1 {
    wp::int32 num_cells;
    wp::array_t<wp::int32> cell_nodes;
    wp::array_t<wp::int32> cell_material;
    wp::array_t<wp::int32> cell_active;
    ...
    wp::int32 has_material_filter;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::vec_t<3, wp::float32> ray0_origin;
    wp::vec_t<3, wp::float32> ray0_end;
    wp::vec_t<3, wp::float32> ray1_origin;
    wp::vec_t<3, wp::float32> ray1_end;
    wp::float32 padding;
    wp::array_t<wp::int32> selected_cells;
    wp::array_t<wp::int32> selected_count;
};
...
void select_ray_surface_cells_kernel_b9b84ac1_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_select_ray_surface_cells_kernel_b9b84ac1 *_wp_args)
{
    //---------
    // argument vars
    wp::int32 var_num_cells = _wp_args->num_cells;
    ...
    wp::int32 var_has_material_filter = _wp_args->has_material_filter;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    wp::vec_t<3, wp::float32> var_ray0_origin = _wp_args->ray0_origin;
    wp::vec_t<3, wp::float32> var_ray0_end = _wp_args->ray0_end;
    wp::vec_t<3, wp::float32> var_ray1_origin = _wp_args->ray1_origin;
    wp::vec_t<3, wp::float32> var_ray1_end = _wp_args->ray1_end;
    wp::float32 var_padding = _wp_args->padding;
    wp::array_t<wp::int32> var_selected_cells = _wp_args->selected_cells;
    wp::array_t<wp::int32> var_selected_count = _wp_args->selected_count;
    //---------
...
void select_ray_surface_cells_kernel_b9b84ac1_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_select_ray_surface_cells_kernel_b9b84ac1 *_wp_args,
    wp_args_select_ray_surface_cells_kernel_b9b84ac1 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::int32 var_num_cells = _wp_args->num_cells;
    ...
    wp::int32 adj_has_material_filter = _wp_adj_args->has_material_filter;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_particle_q = _wp_adj_args->particle_q;
    wp::vec_t<3, wp::float32> adj_ray0_origin = _wp_adj_args->ray0_origin;
    wp::vec_t<3, wp::float32> adj_ray0_end = _wp_adj_args->ray0_end;
    wp::vec_t<3, wp::float32> adj_ray1_origin = _wp_adj_args->ray1_origin;
    wp::vec_t<3, wp::float32> adj_ray1_end = _wp_adj_args->ray1_end;
    wp::float32 adj_padding = _wp_adj_args->padding;
    wp::array_t<wp::int32> adj_selected_cells = _wp_adj_args->selected_cells;
    wp::array_t<wp::int32> adj_selected_count = _wp_adj_args->selected_count;
    //---------
...
// Python CPU entry points
WP_API void select_ray_surface_cells_kernel_b9b84ac1_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_select_ray_surface_cells_kernel_b9b84ac1 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        select_ray_surface_cells_kernel_b9b84ac1_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void select_ray_surface_cells_kernel_b9b84ac1_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_select_ray_surface_cells_kernel_b9b84ac1 *_wp_args,
    wp_args_select_ray_surface_cells_kernel_b9b84ac1 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        select_ray_surface_cells_kernel_b9b84ac1_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_finalize_deleted_cell_nodes_kernel_5cf6ef37 {
    wp::array_t<wp::int32> deleted_cells;
    wp::array_t<wp::int32> deleted_count;
    wp::int32 num_cells;
    wp::array_t<wp::int32> cell_nodes;
...
void finalize_deleted_cell_nodes_kernel_5cf6ef37_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_finalize_deleted_cell_nodes_kernel_5cf6ef37 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_deleted_cells = _wp_args->deleted_cells;
...
void finalize_deleted_cell_nodes_kernel_5cf6ef37_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_finalize_deleted_cell_nodes_kernel_5cf6ef37 *_wp_args,
    wp_args_finalize_deleted_cell_nodes_kernel_5cf6ef37 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_deleted_cells = _wp_args->deleted_cells;
...
// Python CPU entry points
WP_API void finalize_deleted_cell_nodes_kernel_5cf6ef37_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_finalize_deleted_cell_nodes_kernel_5cf6ef37 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        finalize_deleted_cell_nodes_kernel_5cf6ef37_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void finalize_deleted_cell_nodes_kernel_5cf6ef37_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_finalize_deleted_cell_nodes_kernel_5cf6ef37 *_wp_args,
    wp_args_finalize_deleted_cell_nodes_kernel_5cf6ef37 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        finalize_deleted_cell_nodes_kernel_5cf6ef37_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_finalize_deactivated_cluster_weights_kernel_0c98401a {
    wp::array_t<wp::int32> deactivated_cluster_ids;
    wp::array_t<wp::int32> deactivated_count;
    wp::array_t<wp::int32> cluster_offsets;
    wp::array_t<wp::int32> cluster_indices;
...
void finalize_deactivated_cluster_weights_kernel_0c98401a_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_finalize_deactivated_cluster_weights_kernel_0c98401a *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_deactivated_cluster_ids = _wp_args->deactivated_cluster_ids;
...
void finalize_deactivated_cluster_weights_kernel_0c98401a_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_finalize_deactivated_cluster_weights_kernel_0c98401a *_wp_args,
    wp_args_finalize_deactivated_cluster_weights_kernel_0c98401a *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_deactivated_cluster_ids = _wp_args->deactivated_cluster_ids;
...
// Python CPU entry points
WP_API void finalize_deactivated_cluster_weights_kernel_0c98401a_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_finalize_deactivated_cluster_weights_kernel_0c98401a *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        finalize_deactivated_cluster_weights_kernel_0c98401a_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void finalize_deactivated_cluster_weights_kernel_0c98401a_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_finalize_deactivated_cluster_weights_kernel_0c98401a *_wp_args,
    wp_args_finalize_deactivated_cluster_weights_kernel_0c98401a *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        finalize_deactivated_cluster_weights_kernel_0c98401a_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args_validate_cell_active_kernel_3a16aa92 {
    wp::array_t<wp::int32> cell_active;
    wp::array_t<wp::int32> error_count;
    wp::array_t<wp::int32> first_error;
};
...
void validate_cell_active_kernel_3a16aa92_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_validate_cell_active_kernel_3a16aa92 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cell_active = _wp_args->cell_active;
...
void validate_cell_active_kernel_3a16aa92_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_validate_cell_active_kernel_3a16aa92 *_wp_args,
    wp_args_validate_cell_active_kernel_3a16aa92 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_cell_active = _wp_args->cell_active;
...
// Python CPU entry points
WP_API void validate_cell_active_kernel_3a16aa92_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args_validate_cell_active_kernel_3a16aa92 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        validate_cell_active_kernel_3a16aa92_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void validate_cell_active_kernel_3a16aa92_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args_validate_cell_active_kernel_3a16aa92 *_wp_args,
    wp_args_validate_cell_active_kernel_3a16aa92 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        validate_cell_active_kernel_3a16aa92_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}
