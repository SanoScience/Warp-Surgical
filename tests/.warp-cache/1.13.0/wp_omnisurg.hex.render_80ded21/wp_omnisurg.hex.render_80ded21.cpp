...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1412
static wp::vec_t<3, wp::float32> _triangle_barycentric_0(
    ...
    wp::vec_t<2, wp::float32> var_c)
{
    ...
    //---------
    // forward
    // def _triangle_barycentric(p: wp.vec2, a: wp.vec2, b: wp.vec2, c: wp.vec2) -> wp.vec3:       <L 1413>
    // v0 = b - a                                                                             <L 1414>
    ...
    // den = v0[0] * v1[1] - v1[0] * v0[1]                                                    <L 1417>
    ...
    // if wp.abs(den) < 1.0e-8:                                                               <L 1418>
    var_14 = wp::abs(var_13);
    var_16 = (var_14 < var_15);
    if (var_16) {
        // return wp.vec3(1.0, 0.0, 0.0)                                                      <L 1419>
        var_20 = wp::vec_t<3, wp::float32>(var_17, var_18, var_19);
        return var_20;
    }
    // inv_den = 1.0 / den                                                                    <L 1420>
    var_22 = wp::div(var_21, var_13);
    // w1 = (v2[0] * v1[1] - v1[0] * v2[1]) * inv_den                                         <L 1421>
    ...
    // w2 = (v0[0] * v2[1] - v2[0] * v0[1]) * inv_den                                         <L 1422>
    ...
    // return wp.vec3(w0, w1, w2)                                                             <L 1424>
    var_50 = wp::vec_t<3, wp::float32>(var_49, var_34, var_46);
    return var_50;
}


// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1427
static wp::vec_t<3, wp::float32> _clamp_barycentric_0(
    wp::vec_t<3, wp::float32> var_w)
{
    ...
    //---------
    // forward
    // def _clamp_barycentric(w: wp.vec3) -> wp.vec3:                                         <L 1428>
    // c0 = wp.max(w[0], 0.0)                                                                 <L 1429>
    var_1 = wp::extract(var_w, var_0);
    var_3 = wp::max(var_1, var_2);
    // c1 = wp.max(w[1], 0.0)                                                                 <L 1430>
    var_5 = wp::extract(var_w, var_4);
    var_7 = wp::max(var_5, var_6);
    // c2 = wp.max(w[2], 0.0)                                                                 <L 1431>
    ...
    if (var_15) {
        // return wp.vec3(1.0, 0.0, 0.0)                                                      <L 1434>
        var_19 = wp::vec_t<3, wp::float32>(var_16, var_17, var_18);
        return var_19;
    }
    // inv_s = 1.0 / s                                                                        <L 1435>
    var_21 = wp::div(var_20, var_13);
    // return wp.vec3(c0 * inv_s, c1 * inv_s, c2 * inv_s)                                     <L 1436>
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1300
static wp::vec_t<3, wp::float32> _lerp_vec3_0(
    ...
    wp::float32 var_t)
{
    ...
    //---------
    // forward
    // def _lerp_vec3(a: wp.vec3, b: wp.vec3, t: float) -> wp.vec3:                           <L 1301>
    // return a + (b - a) * t                                                                 <L 1302>
    var_0 = wp::sub(var_b, var_a);
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1305
static wp::vec_t<3, wp::float32> _cold_warm_stress_color_0(
    wp::float32 var_value)
{
    ...
    //---------
    // forward
    // def _cold_warm_stress_color(value: float) -> wp.vec3:                                  <L 1306>
    // x = wp.clamp(value, 0.0, 1.0)                                                          <L 1308>
    var_2 = wp::clamp(var_value, var_0, var_1);
    // c0 = wp.vec3(0.02, 0.08, 0.70)                                                         <L 1309>
    var_6 = wp::vec_t<3, wp::float32>(var_3, var_4, var_5);
    // c1 = wp.vec3(0.00, 0.72, 1.00)                                                         <L 1310>
    var_10 = wp::vec_t<3, wp::float32>(var_7, var_8, var_9);
    // c2 = wp.vec3(0.05, 0.88, 0.18)                                                         <L 1311>
    var_14 = wp::vec_t<3, wp::float32>(var_11, var_12, var_13);
    // c3 = wp.vec3(1.00, 0.90, 0.05)                                                         <L 1312>
    var_18 = wp::vec_t<3, wp::float32>(var_15, var_16, var_17);
    // c4 = wp.vec3(1.00, 0.04, 0.00)                                                         <L 1313>
    var_22 = wp::vec_t<3, wp::float32>(var_19, var_20, var_21);
    // if x < 0.25:                                                                           <L 1314>
    var_24 = (var_2 < var_23);
    if (var_24) {
        // return _lerp_vec3(c0, c1, x * 4.0)                                                 <L 1315>
    ...
    var_29 = (var_2 < var_28);
    if (var_29) {
        // return _lerp_vec3(c1, c2, (x - 0.25) * 4.0)                                        <L 1317>
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:844
static wp::float32 _select_axis_0(
    ...
    wp::int32 var_axis)
{
    ...
    //---------
    // forward
    // def _select_axis(uv: wp.vec3, axis: int) -> float:                                     <L 845>
    // if axis == 0:                                                                          <L 846>
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:853
static wp::float32 _scale_about_centre_0(
    wp::float32 var_v,
    wp::float32 var_s)
{
    //---------
    ...
    //---------
    // forward
    // def _scale_about_centre(v: float, s: float) -> float:                                  <L 854>
    // return (v - 0.5) / s + 0.5                                                             <L 856>
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1673
static wp::int32 _cluster_edge_slot_a_0(
    wp::int32 var_edge_idx)
{
    ...
    //---------
    // forward
    // def _cluster_edge_slot_a(edge_idx: int) -> int:                                        <L 1674>
    // slot = int(0)                                                                          <L 1675>
    var_1 = wp::int(var_0);
    // if edge_idx == 1:                                                                      <L 1676>
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1699
static wp::int32 _cluster_edge_slot_b_0(
    wp::int32 var_edge_idx)
{
    //---------
    // primal vars
    ...
    //---------
    // forward
    // def _cluster_edge_slot_b(edge_idx: int) -> int:                                        <L 1700>
    // slot = int(1)                                                                          <L 1701>
    var_1 = wp::int(var_0);
    // if edge_idx == 1:                                                                      <L 1702>
    var_3 = (var_edge_idx == var_2);
    if (var_3) {
        // slot = 2                                                                           <L 1703>
    }
...
// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1412
static void adj__triangle_barycentric_0(
    wp::vec_t<2, wp::float32> var_p,
    wp::vec_t<2, wp::float32> var_a,
    wp::vec_t<2, wp::float32> var_b,
    wp::vec_t<2, wp::float32> var_c,
    ...
    wp::vec_t<3, wp::float32> & adj_ret)
{
    ...
    // adj: w2 = (v0[0] * v2[1] - v2[0] * v0[1]) * inv_den                                    <L 1422>
    ...
    // adj: den = v0[0] * v1[1] - v1[0] * v0[1]                                               <L 1417>
    ...
    // adj: v0 = b - a                                                                        <L 1414>
    // adj: def _triangle_barycentric(p: wp.vec2, a: wp.vec2, b: wp.vec2, c: wp.vec2) -> wp.vec3:  <L 1413>
    return;
}


// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1427
static void adj__clamp_barycentric_0(
    wp::vec_t<3, wp::float32> var_w,
    ...
    wp::vec_t<3, wp::float32> & adj_ret)
{
    ...
    wp::adj_sub(var_b, var_a, adj_b, adj_a, adj_0);
    // adj: return a + (b - a) * t                                                            <L 1302>
    // adj: def _lerp_vec3(a: wp.vec3, b: wp.vec3, t: float) -> wp.vec3:                      <L 1301>
    return;
}


// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1305
static void adj__cold_warm_stress_color_0(
    wp::float32 var_value,
    ...
    wp::vec_t<3, wp::float32> & adj_ret)
{
    ...
    // adj: return _lerp_vec3(c3, c4, (x - 0.75) * 4.0)                                       <L 1320>
    if (var_36) {
        label2:;
        adj_41 += adj_ret;
        ...
        // adj: return _lerp_vec3(c2, c3, (x - 0.50) * 4.0)                                   <L 1319>
    }
    // adj: if x < 0.75:                                                                      <L 1318>
    if (var_29) {
        label1:;
        adj_34 += adj_ret;
    ...
    wp::float32 & adj_ret)
{
    ...
    if (var_1) {
        ...
        // adj: return uv[0]                                                                  <L 847>
    }
    // adj: if axis == 0:                                                                     <L 846>
    // adj: def _select_axis(uv: wp.vec3, axis: int) -> float:                                <L 845>
    return;
}


// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:853
static void adj__scale_about_centre_0(
    wp::float32 var_v,
    wp::float32 var_s,
    wp::float32 & adj_v,
    wp::float32 & adj_s,
    wp::float32 & adj_ret)
{
    ...
    // adj: return (v - 0.5) / s + 0.5                                                        <L 856>
    // adj: def _scale_about_centre(v: float, s: float) -> float:                             <L 854>
    return;
}


// /home/pkorzeniowsk/Projects/warp-surgical/warp-surgical-dev/omnisurg/hex/render.py:1673
static void adj__cluster_edge_slot_a_0(
    wp::int32 var_edge_idx,
                                ...
                                if (!var_31) {
                                    ...
                                    if (!var_35) {
                                        ...
                                        if (!var_39) {
                                            ...
                                            // adj: elif edge_idx == 11:                      <L 1722>
                                        }
                                        wp::adj_where(var_39, var_40, var_37, adj_39, adj_40, adj_37, adj_41);
                                        if (var_39) {
                                            // adj: slot = 6                                  <L 1721>
                                        }
                                        // adj: elif edge_idx == 10:                          <L 1720>
                                    }
                                    wp::adj_where(var_35, var_36, var_33, adj_35, adj_36, adj_33, adj_37);
                                    if (var_35) {
                                        // adj: slot = 5                                      <L 1719>
                                    }
                                    // adj: elif edge_idx == 9:                               <L 1718>
                                }
                                wp::adj_where(var_31, var_32, var_29, adj_31, adj_32, adj_29, adj_33);
                                if (var_31) {
                                    // adj: slot = 4                                          <L 1717>
                                }
                                // adj: elif edge_idx == 8:                                   <L 1716>
                            }
                            wp::adj_where(var_27, var_28, var_25, adj_27, adj_28, adj_25, adj_29);
                            if (var_27) {
                                // adj: slot = 4                                              <L 1715>
                            }
                            // adj: elif edge_idx == 7:                                       <L 1714>
                        }
                        wp::adj_where(var_23, var_24, var_21, adj_23, adj_24, adj_21, adj_25);
                        if (var_23) {
                            // adj: slot = 7                                                  <L 1713>
                        }
                        // adj: elif edge_idx == 6:                                           <L 1712>
                    }
                    wp::adj_where(var_19, var_20, var_17, adj_19, adj_20, adj_17, adj_21);
                    if (var_19) {
                        // adj: slot = 6                                                      <L 1711>
                    }
                    // adj: elif edge_idx == 5:                                               <L 1710>
                }
                wp::adj_where(var_15, var_16, var_13, adj_15, adj_16, adj_13, adj_17);
                if (var_15) {
                    // adj: slot = 5                                                          <L 1709>
                }
                // adj: elif edge_idx == 4:                                                   <L 1708>
            }
            wp::adj_where(var_11, var_12, var_9, adj_11, adj_12, adj_9, adj_13);
            if (var_11) {
                // adj: slot = 0                                                              <L 1707>
            }
            // adj: elif edge_idx == 3:                                                       <L 1706>
        }
        wp::adj_where(var_7, var_8, var_5, adj_7, adj_8, adj_5, adj_9);
        if (var_7) {
            // adj: slot = 3                                                                  <L 1705>
        }
        // adj: elif edge_idx == 2:                                                           <L 1704>
    }
    wp::adj_where(var_3, var_4, var_1, adj_3, adj_4, adj_1, adj_5);
    if (var_3) {
        // adj: slot = 2                                                                      <L 1703>
    }
    // adj: if edge_idx == 1:                                                                 <L 1702>
    wp::adj_int(var_0, adj_0, adj_1);
    // adj: slot = int(1)                                                                     <L 1701>
    // adj: def _cluster_edge_slot_b(edge_idx: int) -> int:                                   <L 1700>
    return;
}

struct wp_args__expand_triangle_positions_kernel_61ba38f6 {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_pos;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> flat_pos;
};


void _expand_triangle_positions_kernel_61ba38f6_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_positions_kernel_61ba38f6 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_pos = _wp_args->vertex_pos;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_pos = _wp_args->flat_pos;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // flat_pos[base + 1] = vertex_pos[v1]                                                    <L 1063>
    ...
    // flat_pos[base + 2] = vertex_pos[v2]                                                    <L 1064>
...
void _expand_triangle_positions_kernel_61ba38f6_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_positions_kernel_61ba38f6 *_wp_args,
    wp_args__expand_triangle_positions_kernel_61ba38f6 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> adj_vertex_pos = _wp_adj_args->vertex_pos;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_flat_pos = _wp_adj_args->flat_pos;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: flat_pos[base + 2] = vertex_pos[v2]                                               <L 1064>
    ...
    // adj: flat_pos[base + 1] = vertex_pos[v1]                                               <L 1063>
    ...
    // adj: flat_pos[base + 0] = vertex_pos[v0]                                               <L 1062>
...
WP_API void _expand_triangle_positions_kernel_61ba38f6_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_positions_kernel_61ba38f6 *_wp_args)
{
    ...
    {
        _expand_triangle_positions_kernel_61ba38f6_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _expand_triangle_positions_kernel_61ba38f6_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_positions_kernel_61ba38f6 *_wp_args,
    wp_args__expand_triangle_positions_kernel_61ba38f6 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_positions_kernel_61ba38f6_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__fill_triangle_stress_atlas_kernel_973685e6 {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::float32> cell_stretch;
    wp::float32 color_scale;
    wp::int32 atlas_width;
    wp::int32 atlas_height;
    wp::int32 tile_size;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> atlas_rgb;
};


void _fill_triangle_stress_atlas_kernel_973685e6_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__fill_triangle_stress_atlas_kernel_973685e6 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    wp::array_t<wp::float32> var_cell_stretch = _wp_args->cell_stretch;
    wp::float32 var_color_scale = _wp_args->color_scale;
    wp::int32 var_atlas_width = _wp_args->atlas_width;
    wp::int32 var_atlas_height = _wp_args->atlas_height;
    wp::int32 var_tile_size = _wp_args->tile_size;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> var_atlas_rgb = _wp_args->atlas_rgb;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32 var_1;
    ...
    // s0 = cell_stretch[tri_indices[tid, 0] / 6]                                             <L 1464>
    ...
    // s1 = cell_stretch[tri_indices[tid, 1] / 6]                                             <L 1465>
    ...
    // s2 = cell_stretch[tri_indices[tid, 2] / 6]                                             <L 1466>
    ...
    // if tile_size <= 1:                                                                     <L 1467>
    var_41 = (var_tile_size <= var_40);
    if (var_41) {
        // stress = (s0 + s1 + s2) * (1.0 / 3.0)                                              <L 1468>
    ...
    if (!var_41) {
        ...
        // bary = _clamp_barycentric(_triangle_barycentric(p, a, b, c))                       <L 1474>
        var_68 = _triangle_barycentric_0(var_67, var_50, var_55, var_60);
        var_69 = _clamp_barycentric_0(var_68);
        // stress = s0 * bary[0] + s1 * bary[1] + s2 * bary[2]                                <L 1475>
    ...
    // atlas_rgb[y, x] = _cold_warm_stress_color(stress * color_scale)                        <L 1476>
...
void _fill_triangle_stress_atlas_kernel_973685e6_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__fill_triangle_stress_atlas_kernel_973685e6 *_wp_args,
    wp_args__fill_triangle_stress_atlas_kernel_973685e6 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_atlas_rgb = _wp_args->atlas_rgb;
    wp::array_t<wp::int32> adj_tri_indices = _wp_adj_args->tri_indices;
    wp::array_t<wp::float32> adj_cell_stretch = _wp_adj_args->cell_stretch;
    wp::float32 adj_color_scale = _wp_adj_args->color_scale;
    wp::int32 adj_atlas_width = _wp_adj_args->atlas_width;
    wp::int32 adj_atlas_height = _wp_adj_args->atlas_height;
    wp::int32 adj_tile_size = _wp_adj_args->tile_size;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_atlas_rgb = _wp_adj_args->atlas_rgb;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32 var_1;
    ...
    // adj: atlas_rgb[y, x] = _cold_warm_stress_color(stress * color_scale)                   <L 1476>
    ...
    if (!var_41) {
        ...
        // adj: stress = s0 * bary[0] + s1 * bary[1] + s2 * bary[2]                           <L 1475>
        ...
        // adj: bary = _clamp_barycentric(_triangle_barycentric(p, a, b, c))                  <L 1474>
        ...
        // adj: p = wp.vec2(float(px) + 0.5, float(py) + 0.5)                                 <L 1473>
        ...
        // adj: c = wp.vec2(0.5, float(tile_size) - 0.5)                                      <L 1472>
        ...
        // adj: b = wp.vec2(float(tile_size) - 0.5, 0.5)                                      <L 1471>
        wp::adj_vec_t(var_48, var_49, adj_48, adj_49, adj_50);
        // adj: a = wp.vec2(0.5, 0.5)                                                         <L 1470>
    }
    if (var_41) {
        ...
        // adj: stress = (s0 + s1 + s2) * (1.0 / 3.0)                                         <L 1468>
    }
    // adj: if tile_size <= 1:                                                                <L 1467>
    ...
    // adj: s2 = cell_stretch[tri_indices[tid, 2] / 6]                                        <L 1466>
    ...
    // adj: s1 = cell_stretch[tri_indices[tid, 1] / 6]                                        <L 1465>
    ...
    // adj: s0 = cell_stretch[tri_indices[tid, 0] / 6]                                        <L 1464>
    if (var_13) {
        label1:;
        // adj: return                                                                        <L 1462>
    }
...
// Python CPU entry points
WP_API void _fill_triangle_stress_atlas_kernel_973685e6_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__fill_triangle_stress_atlas_kernel_973685e6 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _fill_triangle_stress_atlas_kernel_973685e6_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _fill_triangle_stress_atlas_kernel_973685e6_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__fill_triangle_stress_atlas_kernel_973685e6 *_wp_args,
    wp_args__fill_triangle_stress_atlas_kernel_973685e6 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _fill_triangle_stress_atlas_kernel_973685e6_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__accumulate_vertex_neighbours_kernel_a0c73fab {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_pos;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> neighbour_sum;
    wp::array_t<wp::int32> neighbour_degree;
};


void _accumulate_vertex_neighbours_kernel_a0c73fab_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__accumulate_vertex_neighbours_kernel_a0c73fab *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_pos = _wp_args->vertex_pos;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> var_neighbour_sum = _wp_args->neighbour_sum;
    wp::array_t<wp::int32> var_neighbour_degree = _wp_args->neighbour_degree;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    wp_args__accumulate_vertex_neighbours_kernel_a0c73fab *_wp_adj_args)
{
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> adj_vertex_pos = _wp_adj_args->vertex_pos;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_neighbour_sum = _wp_adj_args->neighbour_sum;
    wp::array_t<wp::int32> adj_neighbour_degree = _wp_adj_args->neighbour_degree;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: wp.atomic_add(neighbour_sum, v2, p0 + p1)                                         <L 1170>
    ...
    // adj: wp.atomic_add(neighbour_sum, v1, p0 + p2)                                         <L 1169>
    ...
    // adj: wp.atomic_add(neighbour_sum, v0, p1 + p2)                                         <L 1168>
    wp::adj_copy(var_22, adj_20, adj_21);
    wp::adj_address(var_vertex_pos, var_12, adj_vertex_pos, adj_12, adj_20);
    // adj: p2 = vertex_pos[v2]                                                               <L 1166>
    wp::adj_copy(var_19, adj_17, adj_18);
    wp::adj_address(var_vertex_pos, var_8, adj_vertex_pos, adj_8, adj_17);
    // adj: p1 = vertex_pos[v1]                                                               <L 1165>
    wp::adj_copy(var_16, adj_14, adj_15);
    wp::adj_address(var_vertex_pos, var_4, adj_vertex_pos, adj_4, adj_14);
    // adj: p0 = vertex_pos[v0]                                                               <L 1164>
    wp::adj_copy(var_13, adj_11, adj_12);
    wp::adj_address(var_tri_indices, var_0, var_10, adj_tri_indices, adj_0, adj_10, adj_11);
    // adj: v2 = tri_indices[t, 2]                                                            <L 1163>
    wp::adj_copy(var_9, adj_7, adj_8);
    wp::adj_address(var_tri_indices, var_0, var_6, adj_tri_indices, adj_0, adj_6, adj_7);
    // adj: v1 = tri_indices[t, 1]                                                            <L 1162>
    wp::adj_copy(var_5, adj_3, adj_4);
    wp::adj_address(var_tri_indices, var_0, var_2, adj_tri_indices, adj_0, adj_2, adj_3);
    // adj: v0 = tri_indices[t, 0]                                                            <L 1161>
    if (var_1) {
        label0:;
        // adj: return                                                                        <L 1160>
    }
    // adj: if t >= num_triangles:                                                            <L 1159>
    // adj: t = wp.tid()                                                                      <L 1158>
    // adj: def _accumulate_vertex_neighbours_kernel(                                         <L 1150>
    return;
}
...
// Python CPU entry points
WP_API void _accumulate_vertex_neighbours_kernel_a0c73fab_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__accumulate_vertex_neighbours_kernel_a0c73fab *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _accumulate_vertex_neighbours_kernel_a0c73fab_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _accumulate_vertex_neighbours_kernel_a0c73fab_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__accumulate_vertex_neighbours_kernel_a0c73fab *_wp_args,
    wp_args__accumulate_vertex_neighbours_kernel_a0c73fab *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _accumulate_vertex_neighbours_kernel_a0c73fab_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__bake_triangle_texture_kernel_28b457dc {
    wp::array_t<wp::vec_t<3, wp::float32>> flat_vertex_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> texture;
    wp::int32 tex_nx;
    wp::int32 tex_ny;
    wp::int32 tex_nz;
    wp::int32 src_x;
...
void _bake_triangle_texture_kernel_28b457dc_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__bake_triangle_texture_kernel_28b457dc *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_vertex_uv3 = _wp_args->flat_vertex_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> var_texture = _wp_args->texture;
    wp::int32 var_tex_nx = _wp_args->tex_nx;
    wp::int32 var_tex_ny = _wp_args->tex_ny;
    wp::int32 var_tex_nz = _wp_args->tex_nz;
    wp::int32 var_src_x = _wp_args->src_x;
    wp::int32 var_src_y = _wp_args->src_y;
    wp::int32 var_src_z = _wp_args->src_z;
    wp::int32 var_flip_x = _wp_args->flip_x;
    wp::int32 var_flip_y = _wp_args->flip_y;
    wp::int32 var_flip_z = _wp_args->flip_z;
    wp::float32 var_scale_x = _wp_args->scale_x;
    wp::float32 var_scale_y = _wp_args->scale_y;
    wp::float32 var_scale_z = _wp_args->scale_z;
    wp::int32 var_atlas_width = _wp_args->atlas_width;
    wp::int32 var_atlas_height = _wp_args->atlas_height;
    wp::int32 var_tile_size = _wp_args->tile_size;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    ...
    //---------
    // forward
    // def _bake_triangle_texture_kernel(                                                     <L 1480>
    // tx, ty, sub = wp.tid()                                                                 <L 1502>
    builtin_tid3d(var_0, var_1, var_2);
    // tiles_per_row = atlas_width / tile_size                                                <L 1503>
    var_3 = wp::div(var_atlas_width, var_tile_size);
    // tid = ty * tiles_per_row + tx                                                          <L 1504>
    var_4 = wp::mul(var_1, var_3);
    var_5 = wp::add(var_4, var_0);
    // if tid >= num_triangles:                                                               <L 1505>
    var_6 = (var_5 >= var_num_triangles);
    if (var_6) {
        // return                                                                             <L 1506>
        return;
    }
    // px = sub % tile_size                                                                   <L 1508>
    var_7 = wp::mod(var_2, var_tile_size);
    // py = sub / tile_size                                                                   <L 1509>
    var_8 = wp::div(var_2, var_tile_size);
    // x = tx * tile_size + px                                                                <L 1510>
    var_9 = wp::mul(var_0, var_tile_size);
    var_10 = wp::add(var_9, var_7);
    // y = ty * tile_size + py                                                                <L 1511>
    var_11 = wp::mul(var_1, var_tile_size);
    var_12 = wp::add(var_11, var_8);
    // if x >= atlas_width or y >= atlas_height:                                              <L 1512>
    var_14 = (var_10 >= var_atlas_width);
    var_13 = var_14;
    if (!var_13) {
        var_15 = (var_12 >= var_atlas_height);
    ...
    if (var_17) {
        ...
        // + flat_vertex_uv3[tid * 3 + 2]                                                     <L 1519>
    ...
    if (!var_17) {
        ...
        // bary = _clamp_barycentric(_triangle_barycentric(p, a, b, c))                       <L 1526>
        var_62 = _triangle_barycentric_0(var_61, var_44, var_49, var_54);
        var_63 = _clamp_barycentric_0(var_62);
        // uv = (                                                                             <L 1527>
        // flat_vertex_uv3[tid * 3 + 0] * bary[0]                                             <L 1528>
        ...
        // + flat_vertex_uv3[tid * 3 + 1] * bary[1]                                           <L 1529>
        ...
        // + flat_vertex_uv3[tid * 3 + 2] * bary[2]                                           <L 1530>
    ...
    // iy = wp.clamp(int(tex_v * float(tex_ny)), 0, tex_ny - 1)                               <L 1537>
    ...
    // iz = wp.clamp(int(tex_w * float(tex_nz)), 0, tex_nz - 1)                               <L 1538>
...
void _bake_triangle_texture_kernel_28b457dc_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__bake_triangle_texture_kernel_28b457dc *_wp_args,
    wp_args__bake_triangle_texture_kernel_28b457dc *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_vertex_uv3 = _wp_args->flat_vertex_uv3;
    ...
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> var_atlas_rgb = _wp_args->atlas_rgb;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_flat_vertex_uv3 = _wp_adj_args->flat_vertex_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_texture = _wp_adj_args->texture;
    wp::int32 adj_tex_nx = _wp_adj_args->tex_nx;
    wp::int32 adj_tex_ny = _wp_adj_args->tex_ny;
    wp::int32 adj_tex_nz = _wp_adj_args->tex_nz;
    wp::int32 adj_src_x = _wp_adj_args->src_x;
    wp::int32 adj_src_y = _wp_adj_args->src_y;
    wp::int32 adj_src_z = _wp_adj_args->src_z;
    wp::int32 adj_flip_x = _wp_adj_args->flip_x;
    wp::int32 adj_flip_y = _wp_adj_args->flip_y;
    wp::int32 adj_flip_z = _wp_adj_args->flip_z;
    wp::float32 adj_scale_x = _wp_adj_args->scale_x;
    wp::float32 adj_scale_y = _wp_adj_args->scale_y;
    wp::float32 adj_scale_z = _wp_adj_args->scale_z;
    wp::int32 adj_atlas_width = _wp_adj_args->atlas_width;
    wp::int32 adj_atlas_height = _wp_adj_args->atlas_height;
    wp::int32 adj_tile_size = _wp_adj_args->tile_size;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    ...
    // adj: atlas_rgb[y, x] = texture[ix, iy, iz]                                             <L 1545>
    ...
    if (var_134) {
        ...
        // adj: iz = (tex_nz - 1) - iz                                                        <L 1544>
    }
    // adj: if flip_z != 0:                                                                   <L 1543>
    ...
    if (var_128) {
        ...
        // adj: iy = (tex_ny - 1) - iy                                                        <L 1542>
    }
    // adj: if flip_y != 0:                                                                   <L 1541>
    ...
    if (var_122) {
        ...
        // adj: ix = (tex_nx - 1) - ix                                                        <L 1540>
    }
    // adj: if flip_x != 0:                                                                   <L 1539>
    ...
    // adj: iz = wp.clamp(int(tex_w * float(tex_nz)), 0, tex_nz - 1)                          <L 1538>
    ...
    // adj: iy = wp.clamp(int(tex_v * float(tex_ny)), 0, tex_ny - 1)                          <L 1537>
    ...
    // adj: ix = wp.clamp(int(tex_u * float(tex_nx)), 0, tex_nx - 1)                          <L 1536>
    ...
    // adj: tex_w = _scale_about_centre(_select_axis(uv, src_z), scale_z)                     <L 1535>
    ...
    // adj: tex_v = _scale_about_centre(_select_axis(uv, src_y), scale_y)                     <L 1534>
    ...
    // adj: tex_u = _scale_about_centre(_select_axis(uv, src_x), scale_x)                     <L 1533>
    ...
    if (!var_17) {
        ...
        // adj: + flat_vertex_uv3[tid * 3 + 2] * bary[2]                                      <L 1530>
        ...
        // adj: + flat_vertex_uv3[tid * 3 + 1] * bary[1]                                      <L 1529>
        ...
        // adj: flat_vertex_uv3[tid * 3 + 0] * bary[0]                                        <L 1528>
        // adj: uv = (                                                                        <L 1527>
        ...
        // adj: bary = _clamp_barycentric(_triangle_barycentric(p, a, b, c))                  <L 1526>
        ...
        // adj: p = wp.vec2(float(px) + 0.5, float(py) + 0.5)                                 <L 1525>
        wp::adj_vec_t(var_50, var_53, adj_50, adj_53, adj_54);
        wp::adj_sub(var_51, var_52, adj_51, adj_52, adj_53);
        wp::adj_float(var_tile_size, adj_tile_size, adj_51);
        // adj: c = wp.vec2(0.5, float(tile_size) - 0.5)                                      <L 1524>
        ...
        // adj: b = wp.vec2(float(tile_size) - 0.5, 0.5)                                      <L 1523>
        wp::adj_vec_t(var_42, var_43, adj_42, adj_43, adj_44);
        // adj: a = wp.vec2(0.5, 0.5)                                                         <L 1522>
    }
    if (var_17) {
        ...
        // adj: + flat_vertex_uv3[tid * 3 + 2]                                                <L 1519>
        ...
        // adj: + flat_vertex_uv3[tid * 3 + 1]                                                <L 1518>
        ...
        // adj: flat_vertex_uv3[tid * 3 + 0]                                                  <L 1517>
        // adj: uv = (                                                                        <L 1516>
    }
    // adj: if tile_size <= 1:                                                                <L 1515>
    if (var_13) {
        label1:;
        // adj: return                                                                        <L 1513>
    }
    ...
    // adj: if x >= atlas_width or y >= atlas_height:                                         <L 1512>
    wp::adj_add(var_11, var_8, adj_11, adj_8, adj_12);
    wp::adj_mul(var_1, var_tile_size, adj_1, adj_tile_size, adj_11);
    // adj: y = ty * tile_size + py                                                           <L 1511>
    wp::adj_add(var_9, var_7, adj_9, adj_7, adj_10);
    wp::adj_mul(var_0, var_tile_size, adj_0, adj_tile_size, adj_9);
    // adj: x = tx * tile_size + px                                                           <L 1510>
    wp::adj_div(var_2, var_tile_size, var_8, adj_2, adj_tile_size, adj_8);
    // adj: py = sub / tile_size                                                              <L 1509>
    wp::adj_mod(var_2, var_tile_size, adj_2, adj_tile_size, adj_7);
    // adj: px = sub % tile_size                                                              <L 1508>
    if (var_6) {
        label0:;
        // adj: return                                                                        <L 1506>
    }
    // adj: if tid >= num_triangles:                                                          <L 1505>
    wp::adj_add(var_4, var_0, adj_4, adj_0, adj_5);
    wp::adj_mul(var_1, var_3, adj_1, adj_3, adj_4);
    // adj: tid = ty * tiles_per_row + tx                                                     <L 1504>
    wp::adj_div(var_atlas_width, var_tile_size, var_3, adj_atlas_width, adj_tile_size, adj_3);
    // adj: tiles_per_row = atlas_width / tile_size                                           <L 1503>
    // adj: tx, ty, sub = wp.tid()                                                            <L 1502>
    // adj: def _bake_triangle_texture_kernel(                                                <L 1480>
    return;
}
...
// Python CPU entry points
WP_API void _bake_triangle_texture_kernel_28b457dc_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__bake_triangle_texture_kernel_28b457dc *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _bake_triangle_texture_kernel_28b457dc_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _bake_triangle_texture_kernel_28b457dc_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__bake_triangle_texture_kernel_28b457dc *_wp_args,
    wp_args__bake_triangle_texture_kernel_28b457dc *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _bake_triangle_texture_kernel_28b457dc_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__gather_active_particles_kernel_955344fd {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> particle_material;
    wp::array_t<wp::vec_t<3, wp::float32>> material_colors;
    wp::float32 cut_z;
    wp::array_t<wp::int32> counter;
    wp::array_t<wp::vec_t<3, wp::float32>> out_points;
    wp::array_t<wp::vec_t<3, wp::float32>> out_colors;
};


void _gather_active_particles_kernel_955344fd_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_active_particles_kernel_955344fd *_wp_args)
{
    //---------
    // argument vars
    ...
    wp::array_t<wp::int32> var_particle_material = _wp_args->particle_material;
    wp::array_t<wp::vec_t<3, wp::float32>> var_material_colors = _wp_args->material_colors;
    wp::float32 var_cut_z = _wp_args->cut_z;
    wp::array_t<wp::int32> var_counter = _wp_args->counter;
    ...
    //---------
    // forward
    // def _gather_active_particles_kernel(                                                   <L 1549>
    // i = wp.tid()                                                                           <L 1564>
    var_0 = builtin_tid1d();
    // if (particle_flags[i] & wp.int32(ParticleFlags.ACTIVE)) == 0:                          <L 1565>
    ...
    // if particle_q[i][2] > cut_z:                                                           <L 1567>
...
void _gather_active_particles_kernel_955344fd_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_active_particles_kernel_955344fd *_wp_args,
    wp_args__gather_active_particles_kernel_955344fd *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    ...
    wp::array_t<wp::int32> adj_particle_material = _wp_adj_args->particle_material;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_material_colors = _wp_adj_args->material_colors;
    wp::float32 adj_cut_z = _wp_adj_args->cut_z;
    wp::array_t<wp::int32> adj_counter = _wp_adj_args->counter;
    ...
    // adj: out_colors[idx] = material_colors[particle_material[i]]                           <L 1571>
    ...
    // adj: out_points[idx] = particle_q[i]                                                   <L 1570>
    wp::adj_atomic_add(var_counter, var_14, var_15, adj_counter, adj_14, adj_15, adj_16);
    // adj: idx = wp.atomic_add(counter, 0, 1)                                                <L 1569>
    if (var_13) {
        label1:;
        // adj: return                                                                        <L 1568>
    }
    ...
    // adj: if particle_q[i][2] > cut_z:                                                      <L 1567>
    if (var_8) {
        label0:;
        // adj: return                                                                        <L 1566>
    }
    ...
    // adj: if (particle_flags[i] & wp.int32(ParticleFlags.ACTIVE)) == 0:                     <L 1565>
    // adj: i = wp.tid()                                                                      <L 1564>
    // adj: def _gather_active_particles_kernel(                                              <L 1549>
    return;
}
...
// Python CPU entry points
WP_API void _gather_active_particles_kernel_955344fd_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__gather_active_particles_kernel_955344fd *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_active_particles_kernel_955344fd_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _gather_active_particles_kernel_955344fd_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__gather_active_particles_kernel_955344fd *_wp_args,
    wp_args__gather_active_particles_kernel_955344fd *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_active_particles_kernel_955344fd_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__fill_triangle_material_atlas_kernel_f0803b03 {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::int32> particle_material;
    wp::array_t<wp::vec_t<3, wp::float32>> material_colors;
    wp::int32 atlas_width;
...
void _fill_triangle_material_atlas_kernel_f0803b03_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__fill_triangle_material_atlas_kernel_f0803b03 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    //---------
    // forward
    // def _fill_triangle_material_atlas_kernel(                                              <L 1260>
    // tx, ty, sub = wp.tid()                                                                 <L 1271>
    builtin_tid3d(var_0, var_1, var_2);
    // tiles_per_row = atlas_width / tile_size                                                <L 1272>
    var_3 = wp::div(var_atlas_width, var_tile_size);
    // tid = ty * tiles_per_row + tx                                                          <L 1273>
    var_4 = wp::mul(var_1, var_3);
    var_5 = wp::add(var_4, var_0);
    // if tid >= num_triangles:                                                               <L 1274>
    var_6 = (var_5 >= var_num_triangles);
    if (var_6) {
        // return                                                                             <L 1275>
        return;
    }
    // px = sub % tile_size                                                                   <L 1277>
    var_7 = wp::mod(var_2, var_tile_size);
    // py = sub / tile_size                                                                   <L 1278>
    var_8 = wp::div(var_2, var_tile_size);
    // x = tx * tile_size + px                                                                <L 1279>
    var_9 = wp::mul(var_0, var_tile_size);
    var_10 = wp::add(var_9, var_7);
    // y = ty * tile_size + py                                                                <L 1280>
    var_11 = wp::mul(var_1, var_tile_size);
    var_12 = wp::add(var_11, var_8);
    // if x >= atlas_width or y >= atlas_height:                                              <L 1281>
    var_14 = (var_10 >= var_atlas_width);
    var_13 = var_14;
    if (!var_13) {
        var_15 = (var_12 >= var_atlas_height);
    ...
    // atlas_rgb[y, x] = material_colors[mat]                                                 <L 1297>
...
void _fill_triangle_material_atlas_kernel_f0803b03_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__fill_triangle_material_atlas_kernel_f0803b03 *_wp_args,
    wp_args__fill_triangle_material_atlas_kernel_f0803b03 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    // adj: atlas_rgb[y, x] = material_colors[mat]                                            <L 1297>
    ...
    if (!var_41) {
        ...
        // adj: elif m0 == m1 or m0 == m2:                                                    <L 1294>
    }
    ...
    // adj: p2 = tri_indices[tid, 2] / 6                                                      <L 1286>
    ...
    // adj: p1 = tri_indices[tid, 1] / 6                                                      <L 1285>
    wp::adj_div(var_20, var_18, var_19, adj_17, adj_18, adj_19);
    wp::adj_address(var_tri_indices, var_5, var_16, adj_tri_indices, adj_5, adj_16, adj_17);
    // adj: p0 = tri_indices[tid, 0] / 6                                                      <L 1284>
    if (var_13) {
        label1:;
        // adj: return                                                                        <L 1282>
    }
    ...
    // adj: if x >= atlas_width or y >= atlas_height:                                         <L 1281>
    wp::adj_add(var_11, var_8, adj_11, adj_8, adj_12);
    wp::adj_mul(var_1, var_tile_size, adj_1, adj_tile_size, adj_11);
    // adj: y = ty * tile_size + py                                                           <L 1280>
    wp::adj_add(var_9, var_7, adj_9, adj_7, adj_10);
    wp::adj_mul(var_0, var_tile_size, adj_0, adj_tile_size, adj_9);
    // adj: x = tx * tile_size + px                                                           <L 1279>
    wp::adj_div(var_2, var_tile_size, var_8, adj_2, adj_tile_size, adj_8);
    // adj: py = sub / tile_size                                                              <L 1278>
    wp::adj_mod(var_2, var_tile_size, adj_2, adj_tile_size, adj_7);
    // adj: px = sub % tile_size                                                              <L 1277>
    if (var_6) {
        label0:;
        // adj: return                                                                        <L 1275>
    }
    // adj: if tid >= num_triangles:                                                          <L 1274>
    wp::adj_add(var_4, var_0, adj_4, adj_0, adj_5);
    wp::adj_mul(var_1, var_3, adj_1, adj_3, adj_4);
    // adj: tid = ty * tiles_per_row + tx                                                     <L 1273>
    wp::adj_div(var_atlas_width, var_tile_size, var_3, adj_atlas_width, adj_tile_size, adj_3);
    // adj: tiles_per_row = atlas_width / tile_size                                           <L 1272>
    // adj: tx, ty, sub = wp.tid()                                                            <L 1271>
    // adj: def _fill_triangle_material_atlas_kernel(                                         <L 1260>
    return;
}
...
// Python CPU entry points
WP_API void _fill_triangle_material_atlas_kernel_f0803b03_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__fill_triangle_material_atlas_kernel_f0803b03 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _fill_triangle_material_atlas_kernel_f0803b03_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _fill_triangle_material_atlas_kernel_f0803b03_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__fill_triangle_material_atlas_kernel_f0803b03 *_wp_args,
    wp_args__fill_triangle_material_atlas_kernel_f0803b03 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _fill_triangle_material_atlas_kernel_f0803b03_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__gather_cryo_colored_particles_kernel_a370a66f {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::int32> particle_grid_xyz;
    wp::array_t<wp::vec_t<3, wp::float32>> texture;
    wp::float32 inv_grid_nx;
    wp::float32 inv_grid_ny;
    wp::float32 inv_grid_nz;
    wp::int32 tex_nx;
    wp::int32 tex_ny;
    wp::int32 tex_nz;
    wp::int32 src_x;
...
void _gather_cryo_colored_particles_kernel_a370a66f_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_cryo_colored_particles_kernel_a370a66f *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    wp::array_t<wp::int32> var_particle_flags = _wp_args->particle_flags;
    wp::array_t<wp::int32> var_particle_grid_xyz = _wp_args->particle_grid_xyz;
    wp::array_t<wp::vec_t<3, wp::float32>> var_texture = _wp_args->texture;
    wp::float32 var_inv_grid_nx = _wp_args->inv_grid_nx;
    wp::float32 var_inv_grid_ny = _wp_args->inv_grid_ny;
    wp::float32 var_inv_grid_nz = _wp_args->inv_grid_nz;
    wp::int32 var_tex_nx = _wp_args->tex_nx;
    wp::int32 var_tex_ny = _wp_args->tex_ny;
    wp::int32 var_tex_nz = _wp_args->tex_nz;
    wp::int32 var_src_x = _wp_args->src_x;
    ...
    //---------
    // forward
    // def _gather_cryo_colored_particles_kernel(                                             <L 1597>
    // i = wp.tid()                                                                           <L 1629>
    var_0 = builtin_tid1d();
    // if (particle_flags[i] & wp.int32(ParticleFlags.ACTIVE)) == 0:                          <L 1630>
    var_1 = wp::address(var_particle_flags, var_0);
    var_4 = wp::int32(var_3);
    var_6 = wp::load(var_1);
    var_5 = wp::bit_and(var_6, var_4);
    ...
    // if particle_q[i][2] > cut_z:                                                           <L 1632>
    var_9 = wp::address(var_particle_q, var_0);
    var_12 = wp::load(var_9);
    var_11 = wp::extract(var_12, var_10);
    var_13 = (var_11 > var_cut_z);
    ...
    // gx = float(particle_grid_xyz[i, 0]) * inv_grid_nx                                      <L 1634>
    ...
    // iy = wp.clamp(int(tex_v * float(tex_ny)), 0, tex_ny - 1)                               <L 1642>
    ...
    // iz = wp.clamp(int(tex_w * float(tex_nz)), 0, tex_nz - 1)                               <L 1643>
...
void _gather_cryo_colored_particles_kernel_a370a66f_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_cryo_colored_particles_kernel_a370a66f *_wp_args,
    wp_args__gather_cryo_colored_particles_kernel_a370a66f *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> adj_particle_q = _wp_adj_args->particle_q;
    wp::array_t<wp::int32> adj_particle_flags = _wp_adj_args->particle_flags;
    wp::array_t<wp::int32> adj_particle_grid_xyz = _wp_adj_args->particle_grid_xyz;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_texture = _wp_adj_args->texture;
    wp::float32 adj_inv_grid_nx = _wp_adj_args->inv_grid_nx;
    wp::float32 adj_inv_grid_ny = _wp_adj_args->inv_grid_ny;
    wp::float32 adj_inv_grid_nz = _wp_adj_args->inv_grid_nz;
    wp::int32 adj_tex_nx = _wp_adj_args->tex_nx;
    wp::int32 adj_tex_ny = _wp_adj_args->tex_ny;
    wp::int32 adj_tex_nz = _wp_adj_args->tex_nz;
    wp::int32 adj_src_x = _wp_adj_args->src_x;
    ...
    // adj: out_colors[idx] = texture[ix, iy, iz]                                             <L 1652>
    ...
    // adj: out_points[idx] = particle_q[i]                                                   <L 1651>
    wp::adj_atomic_add(var_counter, var_75, var_76, adj_counter, adj_75, adj_76, adj_77);
    // adj: idx = wp.atomic_add(counter, 0, 1)                                                <L 1650>
    ...
    if (var_70) {
        ...
        // adj: iz = (tex_nz - 1) - iz                                                        <L 1649>
    }
    // adj: if flip_z != 0:                                                                   <L 1648>
    ...
    if (var_64) {
        ...
        // adj: iy = (tex_ny - 1) - iy                                                        <L 1647>
    }
    // adj: if flip_y != 0:                                                                   <L 1646>
    ...
    if (var_58) {
        ...
        // adj: ix = (tex_nx - 1) - ix                                                        <L 1645>
    }
    // adj: if flip_x != 0:                                                                   <L 1644>
    ...
    // adj: iz = wp.clamp(int(tex_w * float(tex_nz)), 0, tex_nz - 1)                          <L 1643>
    ...
    // adj: iy = wp.clamp(int(tex_v * float(tex_ny)), 0, tex_ny - 1)                          <L 1642>
    ...
    // adj: ix = wp.clamp(int(tex_u * float(tex_nx)), 0, tex_nx - 1)                          <L 1641>
    ...
    // adj: tex_w = _scale_about_centre(_select_axis(uv, src_z), scale_z)                     <L 1640>
    ...
    // adj: tex_v = _scale_about_centre(_select_axis(uv, src_y), scale_y)                     <L 1639>
    ...
    // adj: tex_u = _scale_about_centre(_select_axis(uv, src_x), scale_x)                     <L 1638>
    wp::adj_vec_t(var_18, var_23, var_28, adj_18, adj_23, adj_28, adj_29);
    // adj: uv = wp.vec3(gx, gy, gz)                                                          <L 1637>
    ...
    // adj: gz = float(particle_grid_xyz[i, 2]) * inv_grid_nz                                 <L 1636>
    ...
    // adj: gy = float(particle_grid_xyz[i, 1]) * inv_grid_ny                                 <L 1635>
    ...
    // adj: gx = float(particle_grid_xyz[i, 0]) * inv_grid_nx                                 <L 1634>
    if (var_13) {
        label1:;
        // adj: return                                                                        <L 1633>
    }
    wp::adj_extract(var_12, var_10, adj_9, adj_10, adj_11);
    wp::adj_address(var_particle_q, var_0, adj_particle_q, adj_0, adj_9);
    // adj: if particle_q[i][2] > cut_z:                                                      <L 1632>
    if (var_8) {
        label0:;
        // adj: return                                                                        <L 1631>
    }
    wp::adj_int32(var_3, adj_3, adj_4);
    wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_1);
    // adj: if (particle_flags[i] & wp.int32(ParticleFlags.ACTIVE)) == 0:                     <L 1630>
    // adj: i = wp.tid()                                                                      <L 1629>
    // adj: def _gather_cryo_colored_particles_kernel(                                        <L 1597>
    return;
}
...
// Python CPU entry points
WP_API void _gather_cryo_colored_particles_kernel_a370a66f_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__gather_cryo_colored_particles_kernel_a370a66f *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_cryo_colored_particles_kernel_a370a66f_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _gather_cryo_colored_particles_kernel_a370a66f_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__gather_cryo_colored_particles_kernel_a370a66f *_wp_args,
    wp_args__gather_cryo_colored_particles_kernel_a370a66f *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_cryo_colored_particles_kernel_a370a66f_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__apply_laplacian_step_kernel_e67fdfd4 {
    wp::array_t<wp::vec_t<3, wp::float32>> src_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> neighbour_sum;
    wp::array_t<wp::int32> neighbour_degree;
    wp::float32 coeff;
    wp::array_t<wp::vec_t<3, wp::float32>> dst_pos;
};


void _apply_laplacian_step_kernel_e67fdfd4_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__apply_laplacian_step_kernel_e67fdfd4 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_src_pos = _wp_args->src_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> var_neighbour_sum = _wp_args->neighbour_sum;
    wp::array_t<wp::int32> var_neighbour_degree = _wp_args->neighbour_degree;
    wp::float32 var_coeff = _wp_args->coeff;
    wp::array_t<wp::vec_t<3, wp::float32>> var_dst_pos = _wp_args->dst_pos;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
    ...
    //---------
    // forward
    // def _apply_laplacian_step_kernel(                                                      <L 1178>
    // vid = wp.tid()                                                                         <L 1186>
    var_0 = builtin_tid1d();
    // degree = neighbour_degree[vid]                                                         <L 1187>
    var_1 = wp::address(var_neighbour_degree, var_0);
    var_3 = wp::load(var_1);
    var_2 = wp::copy(var_3);
    // p = src_pos[vid]                                                                       <L 1188>
    ...
    var_8 = (var_2 <= var_7);
    if (var_8) {
        // dst_pos[vid] = p                                                                   <L 1190>
        wp::array_store(var_dst_pos, var_0, var_5);
        // return                                                                             <L 1191>
        return;
    }
    // avg = neighbour_sum[vid] * (1.0 / float(degree))                                       <L 1192>
    ...
    // dst_pos[vid] = p + (avg - p) * coeff                                                   <L 1193>
...
void _apply_laplacian_step_kernel_e67fdfd4_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__apply_laplacian_step_kernel_e67fdfd4 *_wp_args,
    wp_args__apply_laplacian_step_kernel_e67fdfd4 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_src_pos = _wp_args->src_pos;
    ...
    wp::float32 var_coeff = _wp_args->coeff;
    wp::array_t<wp::vec_t<3, wp::float32>> var_dst_pos = _wp_args->dst_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_src_pos = _wp_adj_args->src_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_neighbour_sum = _wp_adj_args->neighbour_sum;
    wp::array_t<wp::int32> adj_neighbour_degree = _wp_adj_args->neighbour_degree;
    wp::float32 adj_coeff = _wp_adj_args->coeff;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_dst_pos = _wp_adj_args->dst_pos;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
    ...
    // adj: dst_pos[vid] = p + (avg - p) * coeff                                              <L 1193>
...
// Python CPU entry points
WP_API void _apply_laplacian_step_kernel_e67fdfd4_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__apply_laplacian_step_kernel_e67fdfd4 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _apply_laplacian_step_kernel_e67fdfd4_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _apply_laplacian_step_kernel_e67fdfd4_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__apply_laplacian_step_kernel_e67fdfd4 *_wp_args,
    wp_args__apply_laplacian_step_kernel_e67fdfd4 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _apply_laplacian_step_kernel_e67fdfd4_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__sample_3d_texture_kernel_aaa8c598 {
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> texture;
    wp::int32 tex_nx;
    wp::int32 tex_ny;
    wp::int32 tex_nz;
    ...
    wp::float32 scale_y;
    wp::float32 scale_z;
    wp::array_t<wp::vec_t<3, wp::float32>> out_rgb;
};


void _sample_3d_texture_kernel_aaa8c598_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__sample_3d_texture_kernel_aaa8c598 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_uv3 = _wp_args->vertex_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> var_texture = _wp_args->texture;
    wp::int32 var_tex_nx = _wp_args->tex_nx;
    wp::int32 var_tex_ny = _wp_args->tex_ny;
    wp::int32 var_tex_nz = _wp_args->tex_nz;
    ...
    wp::float32 var_scale_y = _wp_args->scale_y;
    wp::float32 var_scale_z = _wp_args->scale_z;
    wp::array_t<wp::vec_t<3, wp::float32>> var_out_rgb = _wp_args->out_rgb;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::vec_t<3, wp::float32>* var_1;
    ...
    //---------
    // forward
    // def _sample_3d_texture_kernel(                                                         <L 860>
    // i = wp.tid()                                                                           <L 886>
    var_0 = builtin_tid1d();
    // uv = vertex_uv3[i]                                                                     <L 887>
    var_1 = wp::address(var_vertex_uv3, var_0);
    var_3 = wp::load(var_1);
    var_2 = wp::copy(var_3);
    // tex_u = _scale_about_centre(_select_axis(uv, src_x), scale_x)                          <L 888>
    var_4 = _select_axis_0(var_2, var_src_x);
    var_5 = _scale_about_centre_0(var_4, var_scale_x);
    // tex_v = _scale_about_centre(_select_axis(uv, src_y), scale_y)                          <L 889>
    var_6 = _select_axis_0(var_2, var_src_y);
    var_7 = _scale_about_centre_0(var_6, var_scale_y);
    // tex_w = _scale_about_centre(_select_axis(uv, src_z), scale_z)                          <L 890>
    var_8 = _select_axis_0(var_2, var_src_z);
    var_9 = _scale_about_centre_0(var_8, var_scale_z);
    // ix = wp.clamp(int(tex_u * float(tex_nx)), 0, tex_nx - 1)                               <L 891>
    ...
    // iy = wp.clamp(int(tex_v * float(tex_ny)), 0, tex_ny - 1)                               <L 892>
    ...
    // iz = wp.clamp(int(tex_w * float(tex_nz)), 0, tex_nz - 1)                               <L 893>
...
void _sample_3d_texture_kernel_aaa8c598_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__sample_3d_texture_kernel_aaa8c598 *_wp_args,
    wp_args__sample_3d_texture_kernel_aaa8c598 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_uv3 = _wp_args->vertex_uv3;
    ...
    wp::float32 var_scale_z = _wp_args->scale_z;
    wp::array_t<wp::vec_t<3, wp::float32>> var_out_rgb = _wp_args->out_rgb;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_vertex_uv3 = _wp_adj_args->vertex_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_texture = _wp_adj_args->texture;
    wp::int32 adj_tex_nx = _wp_adj_args->tex_nx;
    wp::int32 adj_tex_ny = _wp_adj_args->tex_ny;
    wp::int32 adj_tex_nz = _wp_adj_args->tex_nz;
    ...
    wp::float32 adj_scale_y = _wp_adj_args->scale_y;
    wp::float32 adj_scale_z = _wp_adj_args->scale_z;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_out_rgb = _wp_adj_args->out_rgb;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::vec_t<3, wp::float32>* var_1;
    ...
    // adj: out_rgb[i] = texture[ix, iy, iz]                                                  <L 900>
    ...
    if (var_44) {
        ...
        // adj: iz = (tex_nz - 1) - iz                                                        <L 899>
    }
    // adj: if flip_z != 0:                                                                   <L 898>
    ...
    if (var_38) {
        ...
        // adj: iy = (tex_ny - 1) - iy                                                        <L 897>
    }
    // adj: if flip_y != 0:                                                                   <L 896>
    ...
    if (var_32) {
        ...
        // adj: ix = (tex_nx - 1) - ix                                                        <L 895>
    }
    // adj: if flip_x != 0:                                                                   <L 894>
    ...
    // adj: iz = wp.clamp(int(tex_w * float(tex_nz)), 0, tex_nz - 1)                          <L 893>
    ...
    // adj: iy = wp.clamp(int(tex_v * float(tex_ny)), 0, tex_ny - 1)                          <L 892>
    ...
    // adj: ix = wp.clamp(int(tex_u * float(tex_nx)), 0, tex_nx - 1)                          <L 891>
    ...
    // adj: tex_w = _scale_about_centre(_select_axis(uv, src_z), scale_z)                     <L 890>
    ...
    // adj: tex_v = _scale_about_centre(_select_axis(uv, src_y), scale_y)                     <L 889>
    ...
    // adj: tex_u = _scale_about_centre(_select_axis(uv, src_x), scale_x)                     <L 888>
    wp::adj_copy(var_3, adj_1, adj_2);
    wp::adj_address(var_vertex_uv3, var_0, adj_vertex_uv3, adj_0, adj_1);
    // adj: uv = vertex_uv3[i]                                                                <L 887>
    // adj: i = wp.tid()                                                                      <L 886>
    // adj: def _sample_3d_texture_kernel(                                                    <L 860>
    return;
}
...
// Python CPU entry points
WP_API void _sample_3d_texture_kernel_aaa8c598_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__sample_3d_texture_kernel_aaa8c598 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _sample_3d_texture_kernel_aaa8c598_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _sample_3d_texture_kernel_aaa8c598_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__sample_3d_texture_kernel_aaa8c598 *_wp_args,
    wp_args__sample_3d_texture_kernel_aaa8c598 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _sample_3d_texture_kernel_aaa8c598_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3 {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_uv3;
    wp::array_t<wp::int32> particle_material;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> flat_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> flat_uv3;
};


void _expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_pos = _wp_args->vertex_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_uv3 = _wp_args->particle_uv3;
    wp::array_t<wp::int32> var_particle_material = _wp_args->particle_material;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_pos = _wp_args->flat_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_uv3 = _wp_args->flat_uv3;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    //---------
    // forward
    // def _expand_triangle_vertices_majority_uv3_kernel(                                     <L 988>
    // t = wp.tid()                                                                           <L 998>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 999>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 1000>
        return;
    }
    // v0 = tri_indices[t, 0]                                                                 <L 1001>
    var_3 = wp::address(var_tri_indices, var_0, var_2);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // v1 = tri_indices[t, 1]                                                                 <L 1002>
    var_7 = wp::address(var_tri_indices, var_0, var_6);
    var_9 = wp::load(var_7);
    var_8 = wp::copy(var_9);
    // v2 = tri_indices[t, 2]                                                                 <L 1003>
    var_11 = wp::address(var_tri_indices, var_0, var_10);
    var_13 = wp::load(var_11);
    var_12 = wp::copy(var_13);
    // base = t * 3                                                                           <L 1004>
    var_15 = wp::mul(var_0, var_14);
    // flat_pos[base + 0] = vertex_pos[v0]                                                    <L 1005>
    var_16 = wp::address(var_vertex_pos, var_4);
    var_18 = wp::add(var_15, var_17);
    var_19 = wp::load(var_16);
    wp::array_store(var_flat_pos, var_18, var_19);
    // flat_pos[base + 1] = vertex_pos[v1]                                                    <L 1006>
    var_20 = wp::address(var_vertex_pos, var_8);
    var_22 = wp::add(var_15, var_21);
    var_23 = wp::load(var_20);
    wp::array_store(var_flat_pos, var_22, var_23);
    // flat_pos[base + 2] = vertex_pos[v2]                                                    <L 1007>
    var_24 = wp::address(var_vertex_pos, var_12);
    var_26 = wp::add(var_15, var_25);
    var_27 = wp::load(var_24);
    wp::array_store(var_flat_pos, var_26, var_27);
...
void _expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3 *_wp_args,
    wp_args__expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    wp::array_t<wp::int32> adj_tri_indices = _wp_adj_args->tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_vertex_pos = _wp_adj_args->vertex_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_particle_uv3 = _wp_adj_args->particle_uv3;
    wp::array_t<wp::int32> adj_particle_material = _wp_adj_args->particle_material;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_flat_pos = _wp_adj_args->flat_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_flat_uv3 = _wp_adj_args->flat_uv3;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    wp::adj_add(var_15, var_25, adj_15, adj_25, adj_26);
    wp::adj_address(var_vertex_pos, var_12, adj_vertex_pos, adj_12, adj_24);
    // adj: flat_pos[base + 2] = vertex_pos[v2]                                               <L 1007>
    wp::adj_array_store(var_flat_pos, var_22, var_23, adj_flat_pos, adj_22, adj_20);
    wp::adj_add(var_15, var_21, adj_15, adj_21, adj_22);
    wp::adj_address(var_vertex_pos, var_8, adj_vertex_pos, adj_8, adj_20);
    // adj: flat_pos[base + 1] = vertex_pos[v1]                                               <L 1006>
    wp::adj_array_store(var_flat_pos, var_18, var_19, adj_flat_pos, adj_18, adj_16);
    wp::adj_add(var_15, var_17, adj_15, adj_17, adj_18);
    wp::adj_address(var_vertex_pos, var_4, adj_vertex_pos, adj_4, adj_16);
    // adj: flat_pos[base + 0] = vertex_pos[v0]                                               <L 1005>
    wp::adj_mul(var_0, var_14, adj_0, adj_14, adj_15);
    // adj: base = t * 3                                                                      <L 1004>
    wp::adj_copy(var_13, adj_11, adj_12);
    wp::adj_address(var_tri_indices, var_0, var_10, adj_tri_indices, adj_0, adj_10, adj_11);
    // adj: v2 = tri_indices[t, 2]                                                            <L 1003>
    wp::adj_copy(var_9, adj_7, adj_8);
    wp::adj_address(var_tri_indices, var_0, var_6, adj_tri_indices, adj_0, adj_6, adj_7);
    // adj: v1 = tri_indices[t, 1]                                                            <L 1002>
    wp::adj_copy(var_5, adj_3, adj_4);
    wp::adj_address(var_tri_indices, var_0, var_2, adj_tri_indices, adj_0, adj_2, adj_3);
    // adj: v0 = tri_indices[t, 0]                                                            <L 1001>
    if (var_1) {
        label0:;
        // adj: return                                                                        <L 1000>
    }
    // adj: if t >= num_triangles:                                                            <L 999>
    // adj: t = wp.tid()                                                                      <L 998>
    // adj: def _expand_triangle_vertices_majority_uv3_kernel(                                <L 988>
    return;
}
...
// Python CPU entry points
WP_API void _expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3 *_wp_args,
    wp_args__expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_vertices_majority_uv3_kernel_6ad7a9a3_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__expand_triangles_kernel_3dcbeaf2 {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_uv3;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> flat_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> tri_centroid_uv3;
};


void _expand_triangles_kernel_3dcbeaf2_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangles_kernel_3dcbeaf2 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_pos = _wp_args->flat_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> var_tri_centroid_uv3 = _wp_args->tri_centroid_uv3;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    //---------
    // forward
    // def _expand_triangles_kernel(                                                          <L 904>
    // t = wp.tid()                                                                           <L 920>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 921>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 922>
        return;
    }
    // v0 = tri_indices[t, 0]                                                                 <L 923>
    var_3 = wp::address(var_tri_indices, var_0, var_2);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // v1 = tri_indices[t, 1]                                                                 <L 924>
    var_7 = wp::address(var_tri_indices, var_0, var_6);
    var_9 = wp::load(var_7);
    var_8 = wp::copy(var_9);
    // v2 = tri_indices[t, 2]                                                                 <L 925>
    var_11 = wp::address(var_tri_indices, var_0, var_10);
    var_13 = wp::load(var_11);
    var_12 = wp::copy(var_13);
    // flat_pos[t * 3 + 0] = vertex_pos[v0]                                                   <L 926>
    var_14 = wp::address(var_vertex_pos, var_4);
    var_16 = wp::mul(var_0, var_15);
    var_18 = wp::add(var_16, var_17);
    var_19 = wp::load(var_14);
    wp::array_store(var_flat_pos, var_18, var_19);
    // flat_pos[t * 3 + 1] = vertex_pos[v1]                                                   <L 927>
    var_20 = wp::address(var_vertex_pos, var_8);
    var_22 = wp::mul(var_0, var_21);
    var_24 = wp::add(var_22, var_23);
    var_25 = wp::load(var_20);
    wp::array_store(var_flat_pos, var_24, var_25);
    // flat_pos[t * 3 + 2] = vertex_pos[v2]                                                   <L 928>
    ...
    // tri_centroid_uv3[t] = (vertex_uv3[v0] + vertex_uv3[v1] + vertex_uv3[v2]) * (1.0 / 3.0)       <L 929>
...
void _expand_triangles_kernel_3dcbeaf2_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangles_kernel_3dcbeaf2 *_wp_args,
    wp_args__expand_triangles_kernel_3dcbeaf2 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_flat_pos = _wp_adj_args->flat_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_tri_centroid_uv3 = _wp_adj_args->tri_centroid_uv3;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: tri_centroid_uv3[t] = (vertex_uv3[v0] + vertex_uv3[v1] + vertex_uv3[v2]) * (1.0 / 3.0)  <L 929>
    ...
    // adj: flat_pos[t * 3 + 2] = vertex_pos[v2]                                              <L 928>
    ...
    wp::adj_address(var_vertex_pos, var_8, adj_vertex_pos, adj_8, adj_20);
    // adj: flat_pos[t * 3 + 1] = vertex_pos[v1]                                              <L 927>
    ...
    wp::adj_address(var_vertex_pos, var_4, adj_vertex_pos, adj_4, adj_14);
    // adj: flat_pos[t * 3 + 0] = vertex_pos[v0]                                              <L 926>
    wp::adj_copy(var_13, adj_11, adj_12);
    wp::adj_address(var_tri_indices, var_0, var_10, adj_tri_indices, adj_0, adj_10, adj_11);
    // adj: v2 = tri_indices[t, 2]                                                            <L 925>
    wp::adj_copy(var_9, adj_7, adj_8);
    wp::adj_address(var_tri_indices, var_0, var_6, adj_tri_indices, adj_0, adj_6, adj_7);
    // adj: v1 = tri_indices[t, 1]                                                            <L 924>
    wp::adj_copy(var_5, adj_3, adj_4);
    wp::adj_address(var_tri_indices, var_0, var_2, adj_tri_indices, adj_0, adj_2, adj_3);
    // adj: v0 = tri_indices[t, 0]                                                            <L 923>
    if (var_1) {
        label0:;
        // adj: return                                                                        <L 922>
    }
    // adj: if t >= num_triangles:                                                            <L 921>
    // adj: t = wp.tid()                                                                      <L 920>
    // adj: def _expand_triangles_kernel(                                                     <L 904>
    return;
}
...
// Python CPU entry points
WP_API void _expand_triangles_kernel_3dcbeaf2_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangles_kernel_3dcbeaf2 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangles_kernel_3dcbeaf2_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _expand_triangles_kernel_3dcbeaf2_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangles_kernel_3dcbeaf2 *_wp_args,
    wp_args__expand_triangles_kernel_3dcbeaf2 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangles_kernel_3dcbeaf2_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__expand_triangle_vertices_kernel_4cabe833 {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_uv3;
    wp::int32 num_triangles;
...
void _expand_triangle_vertices_kernel_4cabe833_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_vertices_kernel_4cabe833 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    //---------
    // forward
    // def _expand_triangle_vertices_kernel(                                                  <L 933>
    // t = wp.tid()                                                                           <L 942>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 943>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 944>
        return;
    }
    // v0 = tri_indices[t, 0]                                                                 <L 945>
    var_3 = wp::address(var_tri_indices, var_0, var_2);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // v1 = tri_indices[t, 1]                                                                 <L 946>
    var_7 = wp::address(var_tri_indices, var_0, var_6);
    var_9 = wp::load(var_7);
    var_8 = wp::copy(var_9);
    // v2 = tri_indices[t, 2]                                                                 <L 947>
    var_11 = wp::address(var_tri_indices, var_0, var_10);
    var_13 = wp::load(var_11);
    var_12 = wp::copy(var_13);
    // base = t * 3                                                                           <L 948>
    var_15 = wp::mul(var_0, var_14);
    // flat_pos[base + 0] = vertex_pos[v0]                                                    <L 949>
    var_16 = wp::address(var_vertex_pos, var_4);
    var_18 = wp::add(var_15, var_17);
    var_19 = wp::load(var_16);
    wp::array_store(var_flat_pos, var_18, var_19);
    // flat_pos[base + 1] = vertex_pos[v1]                                                    <L 950>
    var_20 = wp::address(var_vertex_pos, var_8);
    var_22 = wp::add(var_15, var_21);
    var_23 = wp::load(var_20);
    wp::array_store(var_flat_pos, var_22, var_23);
    // flat_pos[base + 2] = vertex_pos[v2]                                                    <L 951>
    var_24 = wp::address(var_vertex_pos, var_12);
    var_26 = wp::add(var_15, var_25);
    var_27 = wp::load(var_24);
    wp::array_store(var_flat_pos, var_26, var_27);
    // flat_uv3[base + 0] = vertex_uv3[v0]                                                    <L 952>
...
void _expand_triangle_vertices_kernel_4cabe833_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_vertices_kernel_4cabe833 *_wp_args,
    wp_args__expand_triangle_vertices_kernel_4cabe833 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    // adj: flat_uv3[base + 2] = vertex_uv3[v2]                                               <L 954>
    ...
    // adj: flat_uv3[base + 1] = vertex_uv3[v1]                                               <L 953>
    ...
    // adj: flat_uv3[base + 0] = vertex_uv3[v0]                                               <L 952>
    wp::adj_array_store(var_flat_pos, var_26, var_27, adj_flat_pos, adj_26, adj_24);
    wp::adj_add(var_15, var_25, adj_15, adj_25, adj_26);
    wp::adj_address(var_vertex_pos, var_12, adj_vertex_pos, adj_12, adj_24);
    // adj: flat_pos[base + 2] = vertex_pos[v2]                                               <L 951>
    wp::adj_array_store(var_flat_pos, var_22, var_23, adj_flat_pos, adj_22, adj_20);
    wp::adj_add(var_15, var_21, adj_15, adj_21, adj_22);
    wp::adj_address(var_vertex_pos, var_8, adj_vertex_pos, adj_8, adj_20);
    // adj: flat_pos[base + 1] = vertex_pos[v1]                                               <L 950>
    wp::adj_array_store(var_flat_pos, var_18, var_19, adj_flat_pos, adj_18, adj_16);
    wp::adj_add(var_15, var_17, adj_15, adj_17, adj_18);
    wp::adj_address(var_vertex_pos, var_4, adj_vertex_pos, adj_4, adj_16);
    // adj: flat_pos[base + 0] = vertex_pos[v0]                                               <L 949>
    wp::adj_mul(var_0, var_14, adj_0, adj_14, adj_15);
    // adj: base = t * 3                                                                      <L 948>
    wp::adj_copy(var_13, adj_11, adj_12);
    wp::adj_address(var_tri_indices, var_0, var_10, adj_tri_indices, adj_0, adj_10, adj_11);
    // adj: v2 = tri_indices[t, 2]                                                            <L 947>
    wp::adj_copy(var_9, adj_7, adj_8);
    wp::adj_address(var_tri_indices, var_0, var_6, adj_tri_indices, adj_0, adj_6, adj_7);
    // adj: v1 = tri_indices[t, 1]                                                            <L 946>
    wp::adj_copy(var_5, adj_3, adj_4);
    wp::adj_address(var_tri_indices, var_0, var_2, adj_tri_indices, adj_0, adj_2, adj_3);
    // adj: v0 = tri_indices[t, 0]                                                            <L 945>
    if (var_1) {
        label0:;
        // adj: return                                                                        <L 944>
    }
    // adj: if t >= num_triangles:                                                            <L 943>
    // adj: t = wp.tid()                                                                      <L 942>
    // adj: def _expand_triangle_vertices_kernel(                                             <L 933>
    return;
}
...
// Python CPU entry points
WP_API void _expand_triangle_vertices_kernel_4cabe833_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_vertices_kernel_4cabe833 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_vertices_kernel_4cabe833_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _expand_triangle_vertices_kernel_4cabe833_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_vertices_kernel_4cabe833 *_wp_args,
    wp_args__expand_triangle_vertices_kernel_4cabe833 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_vertices_kernel_4cabe833_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__gather_cluster_box_edges_kernel_76909458 {
    wp::array_t<wp::int32> indices_by_slot;
    wp::array_t<wp::int32> cluster_active;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::int32> particle_flags;
    wp::int32 num_clusters;
    wp::array_t<wp::vec_t<3, wp::float32>> starts;
    wp::array_t<wp::vec_t<3, wp::float32>> ends;
};


void _gather_cluster_box_edges_kernel_76909458_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_cluster_box_edges_kernel_76909458 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_indices_by_slot = _wp_args->indices_by_slot;
    wp::array_t<wp::int32> var_cluster_active = _wp_args->cluster_active;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    wp::array_t<wp::int32> var_particle_flags = _wp_args->particle_flags;
    wp::int32 var_num_clusters = _wp_args->num_clusters;
    wp::array_t<wp::vec_t<3, wp::float32>> var_starts = _wp_args->starts;
    wp::array_t<wp::vec_t<3, wp::float32>> var_ends = _wp_args->ends;
    //---------
    // primal vars
    wp::int32 var_0;
    ...
    //---------
    // forward
    // def _gather_cluster_box_edges_kernel(                                                  <L 1728>
    // tid = wp.tid()                                                                         <L 1737>
    var_0 = builtin_tid1d();
    // cluster_idx = tid // 12                                                                <L 1738>
    var_2 = wp::floordiv(var_0, var_1);
    // edge_idx = tid - cluster_idx * 12                                                      <L 1739>
    var_4 = wp::mul(var_2, var_3);
    var_5 = wp::sub(var_0, var_4);
    // slot_a = _cluster_edge_slot_a(edge_idx)                                                <L 1741>
    var_6 = _cluster_edge_slot_a_0(var_5);
    // slot_b = _cluster_edge_slot_b(edge_idx)                                                <L 1742>
    var_7 = _cluster_edge_slot_b_0(var_5);
    // particle_a = indices_by_slot[slot_a * num_clusters + cluster_idx]                      <L 1743>
    ...
    // particle_b = indices_by_slot[slot_b * num_clusters + cluster_idx]                      <L 1744>
    ...
    // active_bit = wp.int32(ParticleFlags.ACTIVE)                                            <L 1746>
    var_20 = wp::int32(var_19);
    // if (                                                                                   <L 1747>
    // cluster_active[cluster_idx] == 0                                                       <L 1748>
    var_22 = wp::address(var_cluster_active, var_2);
    var_25 = wp::load(var_22);
    var_24 = (var_25 == var_23);
    var_21 = var_24;
    if (!var_21) {
        // or particle_a < 0                                                                  <L 1749>
        var_27 = (var_11 < var_26);
        var_21 = var_21 || var_27;
    }
    if (!var_21) {
        // or particle_b < 0                                                                  <L 1750>
        var_29 = (var_16 < var_28);
        var_21 = var_21 || var_29;
    }
    if (!var_21) {
        // or (particle_flags[particle_a] & active_bit) == 0                                  <L 1751>
    ...
    if (!var_21) {
        // or (particle_flags[particle_b] & active_bit) == 0                                  <L 1752>
    ...
    if (var_21) {
        // p = wp.vec3(0.0, 0.0, 0.0)                                                         <L 1754>
        var_43 = wp::vec_t<3, wp::float32>(var_40, var_41, var_42);
        // if particle_a >= 0:                                                                <L 1755>
        var_45 = (var_11 >= var_44);
        if (var_45) {
            // p = particle_q[particle_a]                                                     <L 1756>
...
void _gather_cluster_box_edges_kernel_76909458_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_cluster_box_edges_kernel_76909458 *_wp_args,
    wp_args__gather_cluster_box_edges_kernel_76909458 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_indices_by_slot = _wp_args->indices_by_slot;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_starts = _wp_args->starts;
    wp::array_t<wp::vec_t<3, wp::float32>> var_ends = _wp_args->ends;
    wp::array_t<wp::int32> adj_indices_by_slot = _wp_adj_args->indices_by_slot;
    wp::array_t<wp::int32> adj_cluster_active = _wp_adj_args->cluster_active;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_particle_q = _wp_adj_args->particle_q;
    wp::array_t<wp::int32> adj_particle_flags = _wp_adj_args->particle_flags;
    wp::int32 adj_num_clusters = _wp_adj_args->num_clusters;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_starts = _wp_adj_args->starts;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_ends = _wp_adj_args->ends;
    //---------
    // primal vars
    wp::int32 var_0;
    const wp::int32 var_1 = 12;
    ...
    if (!var_21) {
        ...
        // adj: ends[tid] = particle_q[particle_b]                                            <L 1761>
    ...
    if (var_21) {
        ...
        if (var_45) {
            ...
            // adj: p = particle_q[particle_a]                                                <L 1756>
        }
        // adj: if particle_a >= 0:                                                           <L 1755>
        wp::adj_vec_t(var_40, var_41, var_42, adj_40, adj_41, adj_42, adj_43);
        // adj: p = wp.vec3(0.0, 0.0, 0.0)                                                    <L 1754>
    }
    if (!var_21) {
        wp::adj_address(var_particle_flags, var_16, adj_particle_flags, adj_16, adj_35);
        // adj: or (particle_flags[particle_b] & active_bit) == 0                             <L 1752>
    }
    if (!var_21) {
        wp::adj_address(var_particle_flags, var_11, adj_particle_flags, adj_11, adj_30);
        // adj: or (particle_flags[particle_a] & active_bit) == 0                             <L 1751>
    }
    if (!var_21) {
        // adj: or particle_b < 0                                                             <L 1750>
    }
    if (!var_21) {
        // adj: or particle_a < 0                                                             <L 1749>
    }
    wp::adj_address(var_cluster_active, var_2, adj_cluster_active, adj_2, adj_22);
    // adj: cluster_active[cluster_idx] == 0                                                  <L 1748>
    // adj: if (                                                                              <L 1747>
    wp::adj_int32(var_19, adj_19, adj_20);
    // adj: active_bit = wp.int32(ParticleFlags.ACTIVE)                                       <L 1746>
    ...
    // adj: particle_b = indices_by_slot[slot_b * num_clusters + cluster_idx]                 <L 1744>
    ...
    // adj: particle_a = indices_by_slot[slot_a * num_clusters + cluster_idx]                 <L 1743>
    adj__cluster_edge_slot_b_0(var_5, adj_5, adj_7);
    // adj: slot_b = _cluster_edge_slot_b(edge_idx)                                           <L 1742>
    adj__cluster_edge_slot_a_0(var_5, adj_5, adj_6);
    // adj: slot_a = _cluster_edge_slot_a(edge_idx)                                           <L 1741>
    wp::adj_sub(var_0, var_4, adj_0, adj_4, adj_5);
    wp::adj_mul(var_2, var_3, adj_2, adj_3, adj_4);
    // adj: edge_idx = tid - cluster_idx * 12                                                 <L 1739>
    // adj: cluster_idx = tid // 12                                                           <L 1738>
    // adj: tid = wp.tid()                                                                    <L 1737>
    // adj: def _gather_cluster_box_edges_kernel(                                             <L 1728>
    return;
}
...
// Python CPU entry points
WP_API void _gather_cluster_box_edges_kernel_76909458_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__gather_cluster_box_edges_kernel_76909458 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_cluster_box_edges_kernel_76909458_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _gather_cluster_box_edges_kernel_76909458_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__gather_cluster_box_edges_kernel_76909458 *_wp_args,
    wp_args__gather_cluster_box_edges_kernel_76909458 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_cluster_box_edges_kernel_76909458_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__fill_atlas_tiles_kernel_aab98030 {
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_rgb;
    wp::int32 atlas_width;
    wp::int32 atlas_height;
    wp::int32 tile_size;
    wp::int32 num_vertices;
    wp::array_t<wp::vec_t<3, wp::float32>> atlas_rgb;
};


void _fill_atlas_tiles_kernel_aab98030_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__fill_atlas_tiles_kernel_aab98030 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_rgb = _wp_args->vertex_rgb;
    wp::int32 var_atlas_width = _wp_args->atlas_width;
    wp::int32 var_atlas_height = _wp_args->atlas_height;
    wp::int32 var_tile_size = _wp_args->tile_size;
    wp::int32 var_num_vertices = _wp_args->num_vertices;
    wp::array_t<wp::vec_t<3, wp::float32>> var_atlas_rgb = _wp_args->atlas_rgb;
    //---------
    // primal vars
    wp::int32 var_0;
    ...
    //---------
    // forward
    // def _fill_atlas_tiles_kernel(                                                          <L 1389>
    // tx, ty, sub = wp.tid()                                                                 <L 1398>
    builtin_tid3d(var_0, var_1, var_2);
    // tiles_per_row = atlas_width / tile_size                                                <L 1399>
    var_3 = wp::div(var_atlas_width, var_tile_size);
    // vid = ty * tiles_per_row + tx                                                          <L 1400>
    var_4 = wp::mul(var_1, var_3);
    var_5 = wp::add(var_4, var_0);
    // if vid >= num_vertices:                                                                <L 1401>
    var_6 = (var_5 >= var_num_vertices);
    if (var_6) {
        // return                                                                             <L 1402>
        return;
    }
    // px = sub % tile_size                                                                   <L 1403>
    var_7 = wp::mod(var_2, var_tile_size);
    // py = sub / tile_size                                                                   <L 1404>
    var_8 = wp::div(var_2, var_tile_size);
    // x = tx * tile_size + px                                                                <L 1405>
    var_9 = wp::mul(var_0, var_tile_size);
    var_10 = wp::add(var_9, var_7);
    // y = ty * tile_size + py                                                                <L 1406>
    var_11 = wp::mul(var_1, var_tile_size);
    var_12 = wp::add(var_11, var_8);
    // if x >= atlas_width or y >= atlas_height:                                              <L 1407>
    var_14 = (var_10 >= var_atlas_width);
    var_13 = var_14;
    if (!var_13) {
        var_15 = (var_12 >= var_atlas_height);
    ...
    // atlas_rgb[y, x] = vertex_rgb[vid]                                                      <L 1409>
...
void _fill_atlas_tiles_kernel_aab98030_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__fill_atlas_tiles_kernel_aab98030 *_wp_args,
    wp_args__fill_atlas_tiles_kernel_aab98030 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_rgb = _wp_args->vertex_rgb;
    ...
    wp::int32 var_num_vertices = _wp_args->num_vertices;
    wp::array_t<wp::vec_t<3, wp::float32>> var_atlas_rgb = _wp_args->atlas_rgb;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_vertex_rgb = _wp_adj_args->vertex_rgb;
    wp::int32 adj_atlas_width = _wp_adj_args->atlas_width;
    wp::int32 adj_atlas_height = _wp_adj_args->atlas_height;
    wp::int32 adj_tile_size = _wp_adj_args->tile_size;
    wp::int32 adj_num_vertices = _wp_adj_args->num_vertices;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_atlas_rgb = _wp_adj_args->atlas_rgb;
    //---------
    // primal vars
    wp::int32 var_0;
    ...
    // adj: atlas_rgb[y, x] = vertex_rgb[vid]                                                 <L 1409>
    if (var_13) {
        label1:;
        // adj: return                                                                        <L 1408>
    }
    ...
    // adj: if x >= atlas_width or y >= atlas_height:                                         <L 1407>
    wp::adj_add(var_11, var_8, adj_11, adj_8, adj_12);
    wp::adj_mul(var_1, var_tile_size, adj_1, adj_tile_size, adj_11);
    // adj: y = ty * tile_size + py                                                           <L 1406>
    wp::adj_add(var_9, var_7, adj_9, adj_7, adj_10);
    wp::adj_mul(var_0, var_tile_size, adj_0, adj_tile_size, adj_9);
    // adj: x = tx * tile_size + px                                                           <L 1405>
    wp::adj_div(var_2, var_tile_size, var_8, adj_2, adj_tile_size, adj_8);
    // adj: py = sub / tile_size                                                              <L 1404>
    wp::adj_mod(var_2, var_tile_size, adj_2, adj_tile_size, adj_7);
    // adj: px = sub % tile_size                                                              <L 1403>
    if (var_6) {
        label0:;
        // adj: return                                                                        <L 1402>
    }
    // adj: if vid >= num_vertices:                                                           <L 1401>
    wp::adj_add(var_4, var_0, adj_4, adj_0, adj_5);
    wp::adj_mul(var_1, var_3, adj_1, adj_3, adj_4);
    // adj: vid = ty * tiles_per_row + tx                                                     <L 1400>
    wp::adj_div(var_atlas_width, var_tile_size, var_3, adj_atlas_width, adj_tile_size, adj_3);
    // adj: tiles_per_row = atlas_width / tile_size                                           <L 1399>
    // adj: tx, ty, sub = wp.tid()                                                            <L 1398>
    // adj: def _fill_atlas_tiles_kernel(                                                     <L 1389>
    return;
}
...
// Python CPU entry points
WP_API void _fill_atlas_tiles_kernel_aab98030_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__fill_atlas_tiles_kernel_aab98030 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _fill_atlas_tiles_kernel_aab98030_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _fill_atlas_tiles_kernel_aab98030_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__fill_atlas_tiles_kernel_aab98030 *_wp_args,
    wp_args__fill_atlas_tiles_kernel_aab98030 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _fill_atlas_tiles_kernel_aab98030_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__expand_triangle_normals_kernel_fcdd309b {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_normals;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> flat_normals;
};


void _expand_triangle_normals_kernel_fcdd309b_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_normals_kernel_fcdd309b *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_normals = _wp_args->vertex_normals;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_normals = _wp_args->flat_normals;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    //---------
    // forward
    // def _expand_triangle_normals_kernel(                                                   <L 1068>
    // t = wp.tid()                                                                           <L 1075>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 1076>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 1077>
        return;
    }
    // v0 = tri_indices[t, 0]                                                                 <L 1078>
    var_3 = wp::address(var_tri_indices, var_0, var_2);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // v1 = tri_indices[t, 1]                                                                 <L 1079>
    var_7 = wp::address(var_tri_indices, var_0, var_6);
    var_9 = wp::load(var_7);
    var_8 = wp::copy(var_9);
    // v2 = tri_indices[t, 2]                                                                 <L 1080>
    var_11 = wp::address(var_tri_indices, var_0, var_10);
    var_13 = wp::load(var_11);
    var_12 = wp::copy(var_13);
    // base = t * 3                                                                           <L 1081>
    var_15 = wp::mul(var_0, var_14);
    // flat_normals[base + 0] = vertex_normals[v0]                                            <L 1082>
    var_16 = wp::address(var_vertex_normals, var_4);
    var_18 = wp::add(var_15, var_17);
    var_19 = wp::load(var_16);
    wp::array_store(var_flat_normals, var_18, var_19);
    // flat_normals[base + 1] = vertex_normals[v1]                                            <L 1083>
    var_20 = wp::address(var_vertex_normals, var_8);
    var_22 = wp::add(var_15, var_21);
    var_23 = wp::load(var_20);
    wp::array_store(var_flat_normals, var_22, var_23);
    // flat_normals[base + 2] = vertex_normals[v2]                                            <L 1084>
...
void _expand_triangle_normals_kernel_fcdd309b_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_normals_kernel_fcdd309b *_wp_args,
    wp_args__expand_triangle_normals_kernel_fcdd309b *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_normals = _wp_args->flat_normals;
    wp::array_t<wp::int32> adj_tri_indices = _wp_adj_args->tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_vertex_normals = _wp_adj_args->vertex_normals;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_flat_normals = _wp_adj_args->flat_normals;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: flat_normals[base + 2] = vertex_normals[v2]                                       <L 1084>
    ...
    // adj: flat_normals[base + 1] = vertex_normals[v1]                                       <L 1083>
    ...
    // adj: flat_normals[base + 0] = vertex_normals[v0]                                       <L 1082>
    wp::adj_mul(var_0, var_14, adj_0, adj_14, adj_15);
    // adj: base = t * 3                                                                      <L 1081>
    wp::adj_copy(var_13, adj_11, adj_12);
    wp::adj_address(var_tri_indices, var_0, var_10, adj_tri_indices, adj_0, adj_10, adj_11);
    // adj: v2 = tri_indices[t, 2]                                                            <L 1080>
    wp::adj_copy(var_9, adj_7, adj_8);
    wp::adj_address(var_tri_indices, var_0, var_6, adj_tri_indices, adj_0, adj_6, adj_7);
    // adj: v1 = tri_indices[t, 1]                                                            <L 1079>
    wp::adj_copy(var_5, adj_3, adj_4);
    wp::adj_address(var_tri_indices, var_0, var_2, adj_tri_indices, adj_0, adj_2, adj_3);
    // adj: v0 = tri_indices[t, 0]                                                            <L 1078>
    if (var_1) {
        label0:;
        // adj: return                                                                        <L 1077>
    }
    // adj: if t >= num_triangles:                                                            <L 1076>
    // adj: t = wp.tid()                                                                      <L 1075>
    // adj: def _expand_triangle_normals_kernel(                                              <L 1068>
    return;
}
...
// Python CPU entry points
WP_API void _expand_triangle_normals_kernel_fcdd309b_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_normals_kernel_fcdd309b *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_normals_kernel_fcdd309b_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _expand_triangle_normals_kernel_fcdd309b_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_normals_kernel_fcdd309b *_wp_args,
    wp_args__expand_triangle_normals_kernel_fcdd309b *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_normals_kernel_fcdd309b_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__compute_vertex_atlas_uvs_kernel_685ffcd1 {
    wp::int32 atlas_width;
    wp::int32 atlas_height;
    wp::int32 tile_size;
    wp::int32 num_vertices;
    wp::array_t<wp::vec_t<2, wp::float32>> out_uvs;
};


void _compute_vertex_atlas_uvs_kernel_685ffcd1_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__compute_vertex_atlas_uvs_kernel_685ffcd1 *_wp_args)
{
    //---------
    // argument vars
    wp::int32 var_atlas_width = _wp_args->atlas_width;
    ...
    wp::int32 var_tile_size = _wp_args->tile_size;
    wp::int32 var_num_vertices = _wp_args->num_vertices;
    wp::array_t<wp::vec_t<2, wp::float32>> var_out_uvs = _wp_args->out_uvs;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
...
void _compute_vertex_atlas_uvs_kernel_685ffcd1_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__compute_vertex_atlas_uvs_kernel_685ffcd1 *_wp_args,
    wp_args__compute_vertex_atlas_uvs_kernel_685ffcd1 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::int32 var_atlas_width = _wp_args->atlas_width;
    ...
    wp::int32 adj_tile_size = _wp_adj_args->tile_size;
    wp::int32 adj_num_vertices = _wp_adj_args->num_vertices;
    wp::array_t<wp::vec_t<2, wp::float32>> adj_out_uvs = _wp_adj_args->out_uvs;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: out_uvs[i] = wp.vec2(cx / float(atlas_width), 1.0 - (cy / float(atlas_height)))   <L 1385>
    ...
    // adj: cy = float(tile_y * tile_size + tile_size / 2)                                    <L 1384>
...
// Python CPU entry points
WP_API void _compute_vertex_atlas_uvs_kernel_685ffcd1_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__compute_vertex_atlas_uvs_kernel_685ffcd1 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _compute_vertex_atlas_uvs_kernel_685ffcd1_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _compute_vertex_atlas_uvs_kernel_685ffcd1_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__compute_vertex_atlas_uvs_kernel_685ffcd1 *_wp_args,
    wp_args__compute_vertex_atlas_uvs_kernel_685ffcd1 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _compute_vertex_atlas_uvs_kernel_685ffcd1_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__compute_flat_triangle_normals_kernel_d5c8e95d {
    wp::array_t<wp::vec_t<3, wp::float32>> flat_pos;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> flat_normals;
};
...
void _compute_flat_triangle_normals_kernel_d5c8e95d_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__compute_flat_triangle_normals_kernel_d5c8e95d *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_pos = _wp_args->flat_pos;
    ...
    //---------
    // forward
    // def _compute_flat_triangle_normals_kernel(                                             <L 1088>
    // t = wp.tid()                                                                           <L 1094>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 1095>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 1096>
        return;
...
void _compute_flat_triangle_normals_kernel_d5c8e95d_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__compute_flat_triangle_normals_kernel_d5c8e95d *_wp_args,
    wp_args__compute_flat_triangle_normals_kernel_d5c8e95d *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_pos = _wp_args->flat_pos;
    ...
    // adj: flat_normals[base + 2] = n                                                        <L 1108>
    ...
    // adj: flat_normals[base + 1] = n                                                        <L 1107>
    ...
    // adj: flat_normals[base + 0] = n                                                        <L 1106>
    ...
    // adj: n = wp.cross(p1 - p0, p2 - p0)                                                    <L 1101>
    ...
    // adj: if t >= num_triangles:                                                            <L 1095>
    // adj: t = wp.tid()                                                                      <L 1094>
    // adj: def _compute_flat_triangle_normals_kernel(                                        <L 1088>
    return;
}
...
// Python CPU entry points
WP_API void _compute_flat_triangle_normals_kernel_d5c8e95d_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__compute_flat_triangle_normals_kernel_d5c8e95d *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _compute_flat_triangle_normals_kernel_d5c8e95d_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _compute_flat_triangle_normals_kernel_d5c8e95d_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__compute_flat_triangle_normals_kernel_d5c8e95d *_wp_args,
    wp_args__compute_flat_triangle_normals_kernel_d5c8e95d *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _compute_flat_triangle_normals_kernel_d5c8e95d_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__gather_stress_colored_particles_kernel_a01b6dde {
    wp::array_t<wp::vec_t<3, wp::float32>> particle_q;
    wp::array_t<wp::int32> particle_flags;
    wp::array_t<wp::float32> cell_stretch;
    wp::float32 color_scale;
...
void _gather_stress_colored_particles_kernel_a01b6dde_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_stress_colored_particles_kernel_a01b6dde *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    ...
    //---------
    // forward
    // def _gather_stress_colored_particles_kernel(                                           <L 1575>
    // i = wp.tid()                                                                           <L 1586>
    var_0 = builtin_tid1d();
    // if (particle_flags[i] & wp.int32(ParticleFlags.ACTIVE)) == 0:                          <L 1587>
    var_1 = wp::address(var_particle_flags, var_0);
    var_4 = wp::int32(var_3);
    var_6 = wp::load(var_1);
    var_5 = wp::bit_and(var_6, var_4);
    ...
    // if particle_q[i][2] > cut_z:                                                           <L 1589>
    var_9 = wp::address(var_particle_q, var_0);
    var_12 = wp::load(var_9);
    var_11 = wp::extract(var_12, var_10);
    var_13 = (var_11 > var_cut_z);
    ...
    // idx = wp.atomic_add(counter, 0, 1)                                                     <L 1591>
    var_16 = wp::atomic_add(var_counter, var_14, var_15);
    // out_points[idx] = particle_q[i]                                                        <L 1592>
    var_17 = wp::address(var_particle_q, var_0);
    var_18 = wp::load(var_17);
    wp::array_store(var_out_points, var_16, var_18);
    // out_colors[idx] = _cold_warm_stress_color(cell_stretch[i] * color_scale)               <L 1593>
...
void _gather_stress_colored_particles_kernel_a01b6dde_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_stress_colored_particles_kernel_a01b6dde *_wp_args,
    wp_args__gather_stress_colored_particles_kernel_a01b6dde *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_q = _wp_args->particle_q;
    ...
    // adj: out_colors[idx] = _cold_warm_stress_color(cell_stretch[i] * color_scale)          <L 1593>
    wp::adj_array_store(var_out_points, var_16, var_18, adj_out_points, adj_16, adj_17);
    wp::adj_address(var_particle_q, var_0, adj_particle_q, adj_0, adj_17);
    // adj: out_points[idx] = particle_q[i]                                                   <L 1592>
    wp::adj_atomic_add(var_counter, var_14, var_15, adj_counter, adj_14, adj_15, adj_16);
    // adj: idx = wp.atomic_add(counter, 0, 1)                                                <L 1591>
    if (var_13) {
        label1:;
        // adj: return                                                                        <L 1590>
    }
    wp::adj_extract(var_12, var_10, adj_9, adj_10, adj_11);
    wp::adj_address(var_particle_q, var_0, adj_particle_q, adj_0, adj_9);
    // adj: if particle_q[i][2] > cut_z:                                                      <L 1589>
    if (var_8) {
        label0:;
        // adj: return                                                                        <L 1588>
    }
    wp::adj_int32(var_3, adj_3, adj_4);
    wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_1);
    // adj: if (particle_flags[i] & wp.int32(ParticleFlags.ACTIVE)) == 0:                     <L 1587>
    // adj: i = wp.tid()                                                                      <L 1586>
    // adj: def _gather_stress_colored_particles_kernel(                                      <L 1575>
    return;
}
...
// Python CPU entry points
WP_API void _gather_stress_colored_particles_kernel_a01b6dde_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__gather_stress_colored_particles_kernel_a01b6dde *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_stress_colored_particles_kernel_a01b6dde_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _gather_stress_colored_particles_kernel_a01b6dde_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__gather_stress_colored_particles_kernel_a01b6dde *_wp_args,
    wp_args__gather_stress_colored_particles_kernel_a01b6dde *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_stress_colored_particles_kernel_a01b6dde_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__flatten_triangle_indices_kernel_192a7807 {
    wp::array_t<wp::int32> tri_indices;
    wp::int32 num_triangles;
    wp::array_t<wp::int32> flat_indices;
};


void _flatten_triangle_indices_kernel_192a7807_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__flatten_triangle_indices_kernel_192a7807 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::int32> var_flat_indices = _wp_args->flat_indices;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    //---------
    // forward
    // def _flatten_triangle_indices_kernel(                                                  <L 1028>
    // t = wp.tid()                                                                           <L 1034>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 1035>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 1036>
        return;
    ...
    // flat_indices[base + 2] = tri_indices[t, 2]                                             <L 1040>
...
void _flatten_triangle_indices_kernel_192a7807_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__flatten_triangle_indices_kernel_192a7807 *_wp_args,
    wp_args__flatten_triangle_indices_kernel_192a7807 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    wp::array_t<wp::int32> adj_tri_indices = _wp_adj_args->tri_indices;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::int32> adj_flat_indices = _wp_adj_args->flat_indices;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: flat_indices[base + 2] = tri_indices[t, 2]                                        <L 1040>
    ...
    // adj: flat_indices[base + 1] = tri_indices[t, 1]                                        <L 1039>
    ...
    // adj: flat_indices[base + 0] = tri_indices[t, 0]                                        <L 1038>
    wp::adj_mul(var_0, var_2, adj_0, adj_2, adj_3);
    // adj: base = t * 3                                                                      <L 1037>
    if (var_1) {
        label0:;
    ...
    // adj: if t >= num_triangles:                                                            <L 1035>
    // adj: t = wp.tid()                                                                      <L 1034>
    // adj: def _flatten_triangle_indices_kernel(                                             <L 1028>
    return;
}
...
// Python CPU entry points
WP_API void _flatten_triangle_indices_kernel_192a7807_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__flatten_triangle_indices_kernel_192a7807 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _flatten_triangle_indices_kernel_192a7807_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _flatten_triangle_indices_kernel_192a7807_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__flatten_triangle_indices_kernel_192a7807 *_wp_args,
    wp_args__flatten_triangle_indices_kernel_192a7807 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _flatten_triangle_indices_kernel_192a7807_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__compute_triangle_tile_uvs_kernel_1ea906ca {
    wp::int32 atlas_width;
    wp::int32 atlas_height;
    wp::int32 tile_size;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<2, wp::float32>> flat_uvs;
};


void _compute_triangle_tile_uvs_kernel_1ea906ca_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__compute_triangle_tile_uvs_kernel_1ea906ca *_wp_args)
{
    //---------
    // argument vars
    wp::int32 var_atlas_width = _wp_args->atlas_width;
    ...
    wp::int32 var_tile_size = _wp_args->tile_size;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<2, wp::float32>> var_flat_uvs = _wp_args->flat_uvs;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    //---------
    // forward
    // def _compute_triangle_tile_uvs_kernel(                                                 <L 1324>
    // t = wp.tid()                                                                           <L 1332>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 1333>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 1334>
        return;
    }
    // tiles_per_row = atlas_width / tile_size                                                <L 1335>
    var_2 = wp::div(var_atlas_width, var_tile_size);
    // tile_x = t % tiles_per_row                                                             <L 1336>
    var_3 = wp::mod(var_0, var_2);
    // tile_y = t / tiles_per_row                                                             <L 1337>
    var_4 = wp::div(var_0, var_2);
    // x0 = float(tile_x * tile_size)                                                         <L 1338>
    var_5 = wp::mul(var_3, var_tile_size);
    var_6 = wp::float(var_5);
    // y0 = float(tile_y * tile_size)                                                         <L 1339>
    var_7 = wp::mul(var_4, var_tile_size);
    var_8 = wp::float(var_7);
    // if tile_size <= 1:                                                                     <L 1340>
    ...
    if (var_10) {
        ...
        // uv = wp.vec2(cx / float(atlas_width), 1.0 - (cy / float(atlas_height)))            <L 1343>
    ...
    // bx = x0 + float(tile_size) - 0.5                                                       <L 1350>
    ...
    // cy = y0 + float(tile_size) - 0.5                                                       <L 1353>
    var_46 = wp::float(var_tile_size);
    var_47 = wp::add(var_8, var_46);
    var_49 = wp::sub(var_47, var_48);
    // flat_uvs[t * 3 + 0] = wp.vec2(ax / float(atlas_width), 1.0 - (ay / float(atlas_height)))       <L 1357>
    ...
    // flat_uvs[t * 3 + 1] = wp.vec2(bx / float(atlas_width), 1.0 - (by / float(atlas_height)))       <L 1358>
    ...
    // flat_uvs[t * 3 + 2] = wp.vec2(cx / float(atlas_width), 1.0 - (cy / float(atlas_height)))       <L 1359>
...
void _compute_triangle_tile_uvs_kernel_1ea906ca_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__compute_triangle_tile_uvs_kernel_1ea906ca *_wp_args,
    wp_args__compute_triangle_tile_uvs_kernel_1ea906ca *_wp_adj_args)
{
    //---------
    // argument vars
    wp::int32 var_atlas_width = _wp_args->atlas_width;
    ...
    wp::int32 adj_tile_size = _wp_adj_args->tile_size;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::vec_t<2, wp::float32>> adj_flat_uvs = _wp_adj_args->flat_uvs;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: flat_uvs[t * 3 + 2] = wp.vec2(cx / float(atlas_width), 1.0 - (cy / float(atlas_height)))  <L 1359>
    ...
    // adj: flat_uvs[t * 3 + 1] = wp.vec2(bx / float(atlas_width), 1.0 - (by / float(atlas_height)))  <L 1358>
    ...
    // adj: flat_uvs[t * 3 + 0] = wp.vec2(ax / float(atlas_width), 1.0 - (ay / float(atlas_height)))  <L 1357>
...
// Python CPU entry points
WP_API void _compute_triangle_tile_uvs_kernel_1ea906ca_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__compute_triangle_tile_uvs_kernel_1ea906ca *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _compute_triangle_tile_uvs_kernel_1ea906ca_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _compute_triangle_tile_uvs_kernel_1ea906ca_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__compute_triangle_tile_uvs_kernel_1ea906ca *_wp_args,
    wp_args__compute_triangle_tile_uvs_kernel_1ea906ca *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _compute_triangle_tile_uvs_kernel_1ea906ca_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__sample_triangle_texture_kernel_81affedf {
    wp::array_t<wp::vec_t<3, wp::float32>> tri_centroid_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> texture;
    wp::int32 tex_nx;
    wp::int32 tex_ny;
    ...
    wp::float32 scale_z;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> tri_rgb;
};


void _sample_triangle_texture_kernel_81affedf_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__sample_triangle_texture_kernel_81affedf *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_tri_centroid_uv3 = _wp_args->tri_centroid_uv3;
    ...
    wp::float32 var_scale_z = _wp_args->scale_z;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> var_tri_rgb = _wp_args->tri_rgb;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    //---------
    // forward
    // def _sample_triangle_texture_kernel(                                                   <L 1197>
    // t = wp.tid()                                                                           <L 1216>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 1217>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 1218>
        return;
    }
    // uv = tri_centroid_uv3[t]                                                               <L 1219>
    var_2 = wp::address(var_tri_centroid_uv3, var_0);
    var_4 = wp::load(var_2);
    var_3 = wp::copy(var_4);
    // tex_u = _scale_about_centre(_select_axis(uv, src_x), scale_x)                          <L 1220>
    var_5 = _select_axis_0(var_3, var_src_x);
    var_6 = _scale_about_centre_0(var_5, var_scale_x);
    // tex_v = _scale_about_centre(_select_axis(uv, src_y), scale_y)                          <L 1221>
    var_7 = _select_axis_0(var_3, var_src_y);
    var_8 = _scale_about_centre_0(var_7, var_scale_y);
    // tex_w = _scale_about_centre(_select_axis(uv, src_z), scale_z)                          <L 1222>
    var_9 = _select_axis_0(var_3, var_src_z);
    var_10 = _scale_about_centre_0(var_9, var_scale_z);
    // ix = wp.clamp(int(tex_u * float(tex_nx)), 0, tex_nx - 1)                               <L 1223>
    ...
    // iy = wp.clamp(int(tex_v * float(tex_ny)), 0, tex_ny - 1)                               <L 1224>
    ...
    // iz = wp.clamp(int(tex_w * float(tex_nz)), 0, tex_nz - 1)                               <L 1225>
...
void _sample_triangle_texture_kernel_81affedf_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__sample_triangle_texture_kernel_81affedf *_wp_args,
    wp_args__sample_triangle_texture_kernel_81affedf *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_tri_centroid_uv3 = _wp_args->tri_centroid_uv3;
    ...
    wp::float32 adj_scale_z = _wp_adj_args->scale_z;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_tri_rgb = _wp_adj_args->tri_rgb;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: tri_rgb[t] = texture[ix, iy, iz]                                                  <L 1232>
    ...
    if (var_45) {
        ...
        // adj: iz = (tex_nz - 1) - iz                                                        <L 1231>
    }
    // adj: if flip_z != 0:                                                                   <L 1230>
    ...
    if (var_39) {
        ...
        // adj: iy = (tex_ny - 1) - iy                                                        <L 1229>
    }
    // adj: if flip_y != 0:                                                                   <L 1228>
    ...
    if (var_33) {
        ...
        // adj: ix = (tex_nx - 1) - ix                                                        <L 1227>
    }
    // adj: if flip_x != 0:                                                                   <L 1226>
    ...
    // adj: iz = wp.clamp(int(tex_w * float(tex_nz)), 0, tex_nz - 1)                          <L 1225>
    ...
    // adj: iy = wp.clamp(int(tex_v * float(tex_ny)), 0, tex_ny - 1)                          <L 1224>
    ...
    // adj: ix = wp.clamp(int(tex_u * float(tex_nx)), 0, tex_nx - 1)                          <L 1223>
    ...
    // adj: tex_w = _scale_about_centre(_select_axis(uv, src_z), scale_z)                     <L 1222>
    ...
    // adj: tex_v = _scale_about_centre(_select_axis(uv, src_y), scale_y)                     <L 1221>
    ...
    // adj: tex_u = _scale_about_centre(_select_axis(uv, src_x), scale_x)                     <L 1220>
    wp::adj_copy(var_4, adj_2, adj_3);
    wp::adj_address(var_tri_centroid_uv3, var_0, adj_tri_centroid_uv3, adj_0, adj_2);
    // adj: uv = tri_centroid_uv3[t]                                                          <L 1219>
    if (var_1) {
        label0:;
        // adj: return                                                                        <L 1218>
    }
    // adj: if t >= num_triangles:                                                            <L 1217>
    // adj: t = wp.tid()                                                                      <L 1216>
    // adj: def _sample_triangle_texture_kernel(                                              <L 1197>
    return;
}
...
// Python CPU entry points
WP_API void _sample_triangle_texture_kernel_81affedf_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__sample_triangle_texture_kernel_81affedf *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _sample_triangle_texture_kernel_81affedf_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _sample_triangle_texture_kernel_81affedf_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__sample_triangle_texture_kernel_81affedf *_wp_args,
    wp_args__sample_triangle_texture_kernel_81affedf *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _sample_triangle_texture_kernel_81affedf_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__fill_triangle_atlas_kernel_fe618cd5 {
    wp::array_t<wp::vec_t<3, wp::float32>> tri_rgb;
    wp::int32 atlas_width;
    wp::int32 atlas_height;
    wp::int32 tile_size;
...
void _fill_triangle_atlas_kernel_fe618cd5_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__fill_triangle_atlas_kernel_fe618cd5 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_tri_rgb = _wp_args->tri_rgb;
    ...
    //---------
    // forward
    // def _fill_triangle_atlas_kernel(                                                       <L 1236>
    // tx, ty, sub = wp.tid()                                                                 <L 1245>
    builtin_tid3d(var_0, var_1, var_2);
    // tiles_per_row = atlas_width / tile_size                                                <L 1246>
    var_3 = wp::div(var_atlas_width, var_tile_size);
    // tid = ty * tiles_per_row + tx                                                          <L 1247>
    var_4 = wp::mul(var_1, var_3);
    var_5 = wp::add(var_4, var_0);
    // if tid >= num_triangles:                                                               <L 1248>
    var_6 = (var_5 >= var_num_triangles);
    if (var_6) {
        // return                                                                             <L 1249>
        return;
    }
    // px = sub % tile_size                                                                   <L 1250>
    var_7 = wp::mod(var_2, var_tile_size);
    // py = sub / tile_size                                                                   <L 1251>
    var_8 = wp::div(var_2, var_tile_size);
    // x = tx * tile_size + px                                                                <L 1252>
    var_9 = wp::mul(var_0, var_tile_size);
    var_10 = wp::add(var_9, var_7);
    // y = ty * tile_size + py                                                                <L 1253>
    var_11 = wp::mul(var_1, var_tile_size);
    var_12 = wp::add(var_11, var_8);
    // if x >= atlas_width or y >= atlas_height:                                              <L 1254>
    var_14 = (var_10 >= var_atlas_width);
    var_13 = var_14;
    if (!var_13) {
        var_15 = (var_12 >= var_atlas_height);
    ...
    // atlas_rgb[y, x] = tri_rgb[tid]                                                         <L 1256>
...
void _fill_triangle_atlas_kernel_fe618cd5_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__fill_triangle_atlas_kernel_fe618cd5 *_wp_args,
    wp_args__fill_triangle_atlas_kernel_fe618cd5 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::vec_t<3, wp::float32>> var_tri_rgb = _wp_args->tri_rgb;
    ...
    // adj: atlas_rgb[y, x] = tri_rgb[tid]                                                    <L 1256>
    if (var_13) {
        label1:;
        // adj: return                                                                        <L 1255>
    }
    ...
    // adj: if x >= atlas_width or y >= atlas_height:                                         <L 1254>
    wp::adj_add(var_11, var_8, adj_11, adj_8, adj_12);
    wp::adj_mul(var_1, var_tile_size, adj_1, adj_tile_size, adj_11);
    // adj: y = ty * tile_size + py                                                           <L 1253>
    wp::adj_add(var_9, var_7, adj_9, adj_7, adj_10);
    wp::adj_mul(var_0, var_tile_size, adj_0, adj_tile_size, adj_9);
    // adj: x = tx * tile_size + px                                                           <L 1252>
    wp::adj_div(var_2, var_tile_size, var_8, adj_2, adj_tile_size, adj_8);
    // adj: py = sub / tile_size                                                              <L 1251>
    wp::adj_mod(var_2, var_tile_size, adj_2, adj_tile_size, adj_7);
    // adj: px = sub % tile_size                                                              <L 1250>
    if (var_6) {
        label0:;
        // adj: return                                                                        <L 1249>
    }
    // adj: if tid >= num_triangles:                                                          <L 1248>
    wp::adj_add(var_4, var_0, adj_4, adj_0, adj_5);
    wp::adj_mul(var_1, var_3, adj_1, adj_3, adj_4);
    // adj: tid = ty * tiles_per_row + tx                                                     <L 1247>
    wp::adj_div(var_atlas_width, var_tile_size, var_3, adj_atlas_width, adj_tile_size, adj_3);
    // adj: tiles_per_row = atlas_width / tile_size                                           <L 1246>
    // adj: tx, ty, sub = wp.tid()                                                            <L 1245>
    // adj: def _fill_triangle_atlas_kernel(                                                  <L 1236>
    return;
}
...
// Python CPU entry points
WP_API void _fill_triangle_atlas_kernel_fe618cd5_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__fill_triangle_atlas_kernel_fe618cd5 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _fill_triangle_atlas_kernel_fe618cd5_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _fill_triangle_atlas_kernel_fe618cd5_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__fill_triangle_atlas_kernel_fe618cd5 *_wp_args,
    wp_args__fill_triangle_atlas_kernel_fe618cd5 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _fill_triangle_atlas_kernel_fe618cd5_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__gather_grab_constraint_lines_kernel_5dd2aa98 {
...
void _gather_grab_constraint_lines_kernel_5dd2aa98_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_grab_constraint_lines_kernel_5dd2aa98 *_wp_args)
{
    //---------
    // argument vars
    ...
    //---------
    // forward
    // def _gather_grab_constraint_lines_kernel(                                              <L 1656>
    // tid = wp.tid()                                                                         <L 1663>
    var_0 = builtin_tid1d();
    // particle_idx = grab_indices[tid]                                                       <L 1664>
    var_1 = wp::address(var_grab_indices, var_0);
    var_3 = wp::load(var_1);
    var_2 = wp::copy(var_3);
    // if particle_idx < 0:                                                                   <L 1665>
    var_5 = (var_2 < var_4);
    if (var_5) {
        // starts[tid] = pull_target                                                          <L 1666>
        wp::array_store(var_starts, var_0, var_pull_target);
        // ends[tid] = pull_target                                                            <L 1667>
        wp::array_store(var_ends, var_0, var_pull_target);
        // return                                                                             <L 1668>
        return;
    }
    // starts[tid] = pull_target                                                              <L 1669>
    wp::array_store(var_starts, var_0, var_pull_target);
    // ends[tid] = particle_q[particle_idx]                                                   <L 1670>
...
void _gather_grab_constraint_lines_kernel_5dd2aa98_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__gather_grab_constraint_lines_kernel_5dd2aa98 *_wp_args,
    wp_args__gather_grab_constraint_lines_kernel_5dd2aa98 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_grab_indices = _wp_args->grab_indices;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_starts = _wp_args->starts;
    wp::array_t<wp::vec_t<3, wp::float32>> var_ends = _wp_args->ends;
    wp::array_t<wp::int32> adj_grab_indices = _wp_adj_args->grab_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_particle_q = _wp_adj_args->particle_q;
    wp::vec_t<3, wp::float32> adj_pull_target = _wp_adj_args->pull_target;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_starts = _wp_adj_args->starts;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_ends = _wp_adj_args->ends;
    //---------
    // primal vars
    ...
    // adj: ends[tid] = particle_q[particle_idx]                                              <L 1670>
    wp::adj_array_store(var_starts, var_0, var_pull_target, adj_starts, adj_0, adj_pull_target);
    // adj: starts[tid] = pull_target                                                         <L 1669>
    if (var_5) {
        label0:;
        // adj: return                                                                        <L 1668>
        wp::adj_array_store(var_ends, var_0, var_pull_target, adj_ends, adj_0, adj_pull_target);
        // adj: ends[tid] = pull_target                                                       <L 1667>
        wp::adj_array_store(var_starts, var_0, var_pull_target, adj_starts, adj_0, adj_pull_target);
        // adj: starts[tid] = pull_target                                                     <L 1666>
    }
    // adj: if particle_idx < 0:                                                              <L 1665>
    wp::adj_copy(var_3, adj_1, adj_2);
    wp::adj_address(var_grab_indices, var_0, adj_grab_indices, adj_0, adj_1);
    // adj: particle_idx = grab_indices[tid]                                                  <L 1664>
    // adj: tid = wp.tid()                                                                    <L 1663>
    // adj: def _gather_grab_constraint_lines_kernel(                                         <L 1656>
    return;
}
...
// Python CPU entry points
WP_API void _gather_grab_constraint_lines_kernel_5dd2aa98_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__gather_grab_constraint_lines_kernel_5dd2aa98 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_grab_constraint_lines_kernel_5dd2aa98_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _gather_grab_constraint_lines_kernel_5dd2aa98_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__gather_grab_constraint_lines_kernel_5dd2aa98 *_wp_args,
    wp_args__gather_grab_constraint_lines_kernel_5dd2aa98 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _gather_grab_constraint_lines_kernel_5dd2aa98_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__expand_triangle_vertices_with_procedural_coord_kernel_0963c69a {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> vertex_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> procedural_coord;
    wp::int32 num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> flat_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> flat_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> flat_procedural_coord;
};


void _expand_triangle_vertices_with_procedural_coord_kernel_0963c69a_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_vertices_with_procedural_coord_kernel_0963c69a *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_pos = _wp_args->vertex_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> var_vertex_uv3 = _wp_args->vertex_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> var_procedural_coord = _wp_args->procedural_coord;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_pos = _wp_args->flat_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_uv3 = _wp_args->flat_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> var_flat_procedural_coord = _wp_args->flat_procedural_coord;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    //---------
    // forward
    // def _expand_triangle_vertices_with_procedural_coord_kernel(                            <L 958>
    // t = wp.tid()                                                                           <L 969>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 970>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 971>
        return;
    }
    // v0 = tri_indices[t, 0]                                                                 <L 972>
    var_3 = wp::address(var_tri_indices, var_0, var_2);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // v1 = tri_indices[t, 1]                                                                 <L 973>
    var_7 = wp::address(var_tri_indices, var_0, var_6);
    var_9 = wp::load(var_7);
    var_8 = wp::copy(var_9);
    // v2 = tri_indices[t, 2]                                                                 <L 974>
    var_11 = wp::address(var_tri_indices, var_0, var_10);
    var_13 = wp::load(var_11);
    var_12 = wp::copy(var_13);
    // base = t * 3                                                                           <L 975>
    var_15 = wp::mul(var_0, var_14);
    // flat_pos[base + 0] = vertex_pos[v0]                                                    <L 976>
    var_16 = wp::address(var_vertex_pos, var_4);
    var_18 = wp::add(var_15, var_17);
    var_19 = wp::load(var_16);
    wp::array_store(var_flat_pos, var_18, var_19);
    // flat_pos[base + 1] = vertex_pos[v1]                                                    <L 977>
    var_20 = wp::address(var_vertex_pos, var_8);
    var_22 = wp::add(var_15, var_21);
    var_23 = wp::load(var_20);
    wp::array_store(var_flat_pos, var_22, var_23);
    // flat_pos[base + 2] = vertex_pos[v2]                                                    <L 978>
    var_24 = wp::address(var_vertex_pos, var_12);
    var_26 = wp::add(var_15, var_25);
    var_27 = wp::load(var_24);
    wp::array_store(var_flat_pos, var_26, var_27);
    // flat_uv3[base + 0] = vertex_uv3[v0]                                                    <L 979>
    var_28 = wp::address(var_vertex_uv3, var_4);
    var_30 = wp::add(var_15, var_29);
    var_31 = wp::load(var_28);
    wp::array_store(var_flat_uv3, var_30, var_31);
    // flat_uv3[base + 1] = vertex_uv3[v1]                                                    <L 980>
    var_32 = wp::address(var_vertex_uv3, var_8);
    var_34 = wp::add(var_15, var_33);
    var_35 = wp::load(var_32);
    wp::array_store(var_flat_uv3, var_34, var_35);
    // flat_uv3[base + 2] = vertex_uv3[v2]                                                    <L 981>
    var_36 = wp::address(var_vertex_uv3, var_12);
    var_38 = wp::add(var_15, var_37);
    var_39 = wp::load(var_36);
    wp::array_store(var_flat_uv3, var_38, var_39);
    // flat_procedural_coord[base + 0] = procedural_coord[v0]                                 <L 982>
    ...
    // flat_procedural_coord[base + 1] = procedural_coord[v1]                                 <L 983>
    ...
    // flat_procedural_coord[base + 2] = procedural_coord[v2]                                 <L 984>
...
void _expand_triangle_vertices_with_procedural_coord_kernel_0963c69a_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_vertices_with_procedural_coord_kernel_0963c69a *_wp_args,
    wp_args__expand_triangle_vertices_with_procedural_coord_kernel_0963c69a *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> adj_vertex_pos = _wp_adj_args->vertex_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_vertex_uv3 = _wp_adj_args->vertex_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_procedural_coord = _wp_adj_args->procedural_coord;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_flat_pos = _wp_adj_args->flat_pos;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_flat_uv3 = _wp_adj_args->flat_uv3;
    wp::array_t<wp::vec_t<3, wp::float32>> adj_flat_procedural_coord = _wp_adj_args->flat_procedural_coord;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: flat_procedural_coord[base + 2] = procedural_coord[v2]                            <L 984>
    ...
    // adj: flat_procedural_coord[base + 1] = procedural_coord[v1]                            <L 983>
    ...
    // adj: flat_procedural_coord[base + 0] = procedural_coord[v0]                            <L 982>
    wp::adj_array_store(var_flat_uv3, var_38, var_39, adj_flat_uv3, adj_38, adj_36);
    wp::adj_add(var_15, var_37, adj_15, adj_37, adj_38);
    wp::adj_address(var_vertex_uv3, var_12, adj_vertex_uv3, adj_12, adj_36);
    // adj: flat_uv3[base + 2] = vertex_uv3[v2]                                               <L 981>
    wp::adj_array_store(var_flat_uv3, var_34, var_35, adj_flat_uv3, adj_34, adj_32);
    wp::adj_add(var_15, var_33, adj_15, adj_33, adj_34);
    wp::adj_address(var_vertex_uv3, var_8, adj_vertex_uv3, adj_8, adj_32);
    // adj: flat_uv3[base + 1] = vertex_uv3[v1]                                               <L 980>
    wp::adj_array_store(var_flat_uv3, var_30, var_31, adj_flat_uv3, adj_30, adj_28);
    wp::adj_add(var_15, var_29, adj_15, adj_29, adj_30);
    wp::adj_address(var_vertex_uv3, var_4, adj_vertex_uv3, adj_4, adj_28);
    // adj: flat_uv3[base + 0] = vertex_uv3[v0]                                               <L 979>
    wp::adj_array_store(var_flat_pos, var_26, var_27, adj_flat_pos, adj_26, adj_24);
    wp::adj_add(var_15, var_25, adj_15, adj_25, adj_26);
    wp::adj_address(var_vertex_pos, var_12, adj_vertex_pos, adj_12, adj_24);
    // adj: flat_pos[base + 2] = vertex_pos[v2]                                               <L 978>
    wp::adj_array_store(var_flat_pos, var_22, var_23, adj_flat_pos, adj_22, adj_20);
    wp::adj_add(var_15, var_21, adj_15, adj_21, adj_22);
    wp::adj_address(var_vertex_pos, var_8, adj_vertex_pos, adj_8, adj_20);
    // adj: flat_pos[base + 1] = vertex_pos[v1]                                               <L 977>
    wp::adj_array_store(var_flat_pos, var_18, var_19, adj_flat_pos, adj_18, adj_16);
    wp::adj_add(var_15, var_17, adj_15, adj_17, adj_18);
    wp::adj_address(var_vertex_pos, var_4, adj_vertex_pos, adj_4, adj_16);
    // adj: flat_pos[base + 0] = vertex_pos[v0]                                               <L 976>
    wp::adj_mul(var_0, var_14, adj_0, adj_14, adj_15);
    // adj: base = t * 3                                                                      <L 975>
    wp::adj_copy(var_13, adj_11, adj_12);
    wp::adj_address(var_tri_indices, var_0, var_10, adj_tri_indices, adj_0, adj_10, adj_11);
    // adj: v2 = tri_indices[t, 2]                                                            <L 974>
    wp::adj_copy(var_9, adj_7, adj_8);
    wp::adj_address(var_tri_indices, var_0, var_6, adj_tri_indices, adj_0, adj_6, adj_7);
    // adj: v1 = tri_indices[t, 1]                                                            <L 973>
    wp::adj_copy(var_5, adj_3, adj_4);
    wp::adj_address(var_tri_indices, var_0, var_2, adj_tri_indices, adj_0, adj_2, adj_3);
    // adj: v0 = tri_indices[t, 0]                                                            <L 972>
    if (var_1) {
        label0:;
        // adj: return                                                                        <L 971>
    }
    // adj: if t >= num_triangles:                                                            <L 970>
    // adj: t = wp.tid()                                                                      <L 969>
    // adj: def _expand_triangle_vertices_with_procedural_coord_kernel(                       <L 958>
    return;
}
...
// Python CPU entry points
WP_API void _expand_triangle_vertices_with_procedural_coord_kernel_0963c69a_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_vertices_with_procedural_coord_kernel_0963c69a *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_vertices_with_procedural_coord_kernel_0963c69a_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _expand_triangle_vertices_with_procedural_coord_kernel_0963c69a_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_vertices_with_procedural_coord_kernel_0963c69a *_wp_args,
    wp_args__expand_triangle_vertices_with_procedural_coord_kernel_0963c69a *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_vertices_with_procedural_coord_kernel_0963c69a_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}

} // extern C

struct wp_args__expand_triangle_material_state_kernel_62443aa8 {
    wp::array_t<wp::int32> tri_indices;
    wp::array_t<wp::int32> particle_material;
    wp::int32 num_triangles;
    wp::array_t<wp::int32> flat_material_id;
    wp::array_t<wp::vec_t<4, wp::float32>> flat_state_rgba;
};


void _expand_triangle_material_state_kernel_62443aa8_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_material_state_kernel_62443aa8 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    wp::array_t<wp::int32> var_particle_material = _wp_args->particle_material;
    wp::int32 var_num_triangles = _wp_args->num_triangles;
    wp::array_t<wp::int32> var_flat_material_id = _wp_args->flat_material_id;
    wp::array_t<wp::vec_t<4, wp::float32>> var_flat_state_rgba = _wp_args->flat_state_rgba;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    //---------
    // forward
    // def _expand_triangle_material_state_kernel(                                            <L 1112>
    // t = wp.tid()                                                                           <L 1120>
    var_0 = builtin_tid1d();
    // if t >= num_triangles:                                                                 <L 1121>
    var_1 = (var_0 >= var_num_triangles);
    if (var_1) {
        // return                                                                             <L 1122>
        return;
    }
    // v0 = tri_indices[t, 0]                                                                 <L 1123>
    var_3 = wp::address(var_tri_indices, var_0, var_2);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // v1 = tri_indices[t, 1]                                                                 <L 1124>
    var_7 = wp::address(var_tri_indices, var_0, var_6);
    var_9 = wp::load(var_7);
    var_8 = wp::copy(var_9);
    // v2 = tri_indices[t, 2]                                                                 <L 1125>
    var_11 = wp::address(var_tri_indices, var_0, var_10);
    var_13 = wp::load(var_11);
    var_12 = wp::copy(var_13);
    // p0 = v0 / 6                                                                            <L 1126>
...
void _expand_triangle_material_state_kernel_62443aa8_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args__expand_triangle_material_state_kernel_62443aa8 *_wp_args,
    wp_args__expand_triangle_material_state_kernel_62443aa8 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_tri_indices = _wp_args->tri_indices;
    ...
    wp::array_t<wp::int32> adj_particle_material = _wp_adj_args->particle_material;
    wp::int32 adj_num_triangles = _wp_adj_args->num_triangles;
    wp::array_t<wp::int32> adj_flat_material_id = _wp_adj_args->flat_material_id;
    wp::array_t<wp::vec_t<4, wp::float32>> adj_flat_state_rgba = _wp_adj_args->flat_state_rgba;
    //---------
    // primal vars
    wp::int32 var_0;
    bool var_1;
    ...
    // adj: flat_state_rgba[base + 2] = zero                                                  <L 1146>
    ...
    // adj: flat_state_rgba[base + 1] = zero                                                  <L 1145>
    ...
    // adj: flat_state_rgba[base + 0] = zero                                                  <L 1144>
    ...
    // adj: flat_material_id[base + 2] = mat                                                  <L 1143>
    ...
    // adj: flat_material_id[base + 1] = mat                                                  <L 1142>
    ...
    // adj: flat_material_id[base + 0] = mat                                                  <L 1141>
    wp::adj_vec_t(var_41, var_42, var_43, var_44, adj_41, adj_42, adj_43, adj_44, adj_45);
    // adj: zero = wp.vec4(0.0, 0.0, 0.0, 0.0)                                                <L 1140>
    ...
    if (!var_30) {
        ...
        // adj: elif m0 == m1 or m0 == m2:                                                    <L 1136>
    }
    ...
    wp::adj_copy(var_13, adj_11, adj_12);
    wp::adj_address(var_tri_indices, var_0, var_10, adj_tri_indices, adj_0, adj_10, adj_11);
    // adj: v2 = tri_indices[t, 2]                                                            <L 1125>
    wp::adj_copy(var_9, adj_7, adj_8);
    wp::adj_address(var_tri_indices, var_0, var_6, adj_tri_indices, adj_0, adj_6, adj_7);
    // adj: v1 = tri_indices[t, 1]                                                            <L 1124>
    wp::adj_copy(var_5, adj_3, adj_4);
    wp::adj_address(var_tri_indices, var_0, var_2, adj_tri_indices, adj_0, adj_2, adj_3);
    // adj: v0 = tri_indices[t, 0]                                                            <L 1123>
    if (var_1) {
        label0:;
        // adj: return                                                                        <L 1122>
    }
    // adj: if t >= num_triangles:                                                            <L 1121>
    // adj: t = wp.tid()                                                                      <L 1120>
    // adj: def _expand_triangle_material_state_kernel(                                       <L 1112>
    return;
}
...
// Python CPU entry points
WP_API void _expand_triangle_material_state_kernel_62443aa8_cpu_forward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_material_state_kernel_62443aa8 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_material_state_kernel_62443aa8_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
...
WP_API void _expand_triangle_material_state_kernel_62443aa8_cpu_backward(
    wp::launch_bounds_t *dim,
    wp_args__expand_triangle_material_state_kernel_62443aa8 *_wp_args,
    wp_args__expand_triangle_material_state_kernel_62443aa8 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        _expand_triangle_material_state_kernel_62443aa8_cpu_kernel_backward(*dim, task_index, _wp_args, _wp_adj_args);
    }
}
