...
def test_liver_mesh_generation():
    ...
    try:
        ...
        print("[TEST] Testing library initialization...")
        generator = WarpCGALMeshGenerator()
        print("[OK] Successfully created WarpCGALMeshGenerator")
        print()
        
        # Test 2: Load image
        print("[LOAD] Loading liver image...")
        ...
        print(f"[OK] Successfully loaded image in {load_time:.2f} seconds")
        print()
        
        # Test 3: Set mesh criteria (optimized for medical data)
        print("[CONFIG] Setting mesh generation criteria...")
        ...
        print("[OK] Mesh criteria set")
        print("   - Facet angle: 25 degrees")
        ...
        print("[MESH] Generating tetrahedral mesh...")
        ...
        print(f"[OK] Successfully generated mesh in {mesh_time:.2f} seconds")
        print()
        
        # Test 5: Get mesh statistics
        print("[STATS] Mesh statistics:")
        ...
        # Test 6: Export mesh
        print("[SAVE] Exporting mesh to file...")
        start_time = time.time()
        
        if not generator.export_mesh(output_mesh_path):
            print("[ERROR] Failed to export mesh")
            return False
            
        export_time = time.time() - start_time
        print(f"[OK] Successfully exported mesh in {export_time:.2f} seconds")
...
def test_convenience_function():
    ...
    try:
        ...
        print("[QUICK] Using convenience function...")
        start_time = time.time()
        ...
        print(f"[OK] Convenience function completed in {total_time:.2f} seconds")
        print(f"   Statistics: {stats}")
        
        return True
        
    except Exception as e:
        print(f"[ERROR] Convenience function failed: {e}")
        return False
